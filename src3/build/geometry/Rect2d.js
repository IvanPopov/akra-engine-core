...
define(["require", "exports", "math", "logger", "geometry/Circle"], function(require, exports, __math__, __logger__, __Circle__) {
    var math = __math__;
    ...
    var Rect2d = (function () {
        ...
        /** inline */ Rect2d.prototype.clear = function () {
            this.x0 = this.x1 = this.y0 = this.y1 = 0.;
            return this;
        };
        ...
        /** inline */ Rect2d.prototype.resizeX = function (fSize) {
        ...
        /** inline */ Rect2d.prototype.resizeY = function (fSize) {
        ...
        /** inline */ Rect2d.prototype.resizeMaxX = function (fSpan) {
            this.x1 = this.x0 + fSpan;
            return this;
        };

        /** inline */ Rect2d.prototype.resizeMaxY = function (fSpan) {
        ...
        /** inline */ Rect2d.prototype.resizeMinX = function (fSpan) {
            this.x0 = this.x1 - fSpan;
            return this;
        };

        /** inline */ Rect2d.prototype.resizeMinY = function (fSpan) {
        ...
        /** inline */ Rect2d.prototype.isEqual = function (pRect) {
            return this.x0 == pRect.x0 && this.x1 == pRect.x1 && this.y0 == pRect.y0 && this.y1 == pRect.y1;
        };

        /** inline */ Rect2d.prototype.isClear = function () {
            return this.x0 == 0. && this.x1 == 0. && this.y0 == 0. && this.y1 == 0.;
        };

        /** inline */ Rect2d.prototype.isValid = function () {
            return this.x0 <= this.x1 && this.y0 <= this.y1;
        };

        /** inline */ Rect2d.prototype.isPointInRect = function (v2fPoint) {
            var x = v2fPoint.x;
            var y = v2fPoint.y;
        ...
        /** inline */ Rect2d.prototype.midX = function () {
            return (this.x0 + this.x1) * 0.5;
        };

        /** inline */ Rect2d.prototype.midY = function () {
        ...
        /** inline */ Rect2d.prototype.sizeX = function () {
            return this.x1 - this.x0;
        };

        /** inline */ Rect2d.prototype.sizeY = function () {
            return this.y1 - this.y0;
        };
        ...
        /** inline */ Rect2d.prototype.area = function () {
