...
define(["require", "exports", "logger", "classify", "geometry/Plane3d"], function(require, exports, __logger__, __classify__, __Plane3d__) {
    ...
    var Frustum = (function () {
        ...
        Frustum.prototype.testRect = function (pRect) {
            if (classify.planeRect3d(this.leftPlane, pRect) == 0 /* PLANE_FRONT */ || classify.planeRect3d(this.rightPlane, pRect) == 0 /* PLANE_FRONT */ || classify.planeRect3d(this.topPlane, pRect) == 0 /* PLANE_FRONT */ || classify.planeRect3d(this.bottomPlane, pRect) == 0 /* PLANE_FRONT */ || classify.planeRect3d(this.nearPlane, pRect) == 0 /* PLANE_FRONT */ || classify.planeRect3d(this.farPlane, pRect) == 0 /* PLANE_FRONT */) {
                return false;
            }
            return true;
        };
        ...
        Frustum.prototype.testSphere = function (pSphere) {
            if (classify.planeSphere(this.leftPlane, pSphere) == 0 /* PLANE_FRONT */ || classify.planeSphere(this.rightPlane, pSphere) == 0 /* PLANE_FRONT */ || classify.planeSphere(this.topPlane, pSphere) == 0 /* PLANE_FRONT */ || classify.planeSphere(this.bottomPlane, pSphere) == 0 /* PLANE_FRONT */ || classify.planeSphere(this.nearPlane, pSphere) == 0 /* PLANE_FRONT */ || classify.planeSphere(this.farPlane, pSphere) == 0 /* PLANE_FRONT */) {
                return false;
            }
            return true;
        };
