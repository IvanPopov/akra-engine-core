...
define(["require", "exports", "generate"], function(require, exports, __gen__) {
    ...
    var Vec4 = (function () {
        ...
        /** inline */ Vec4.prototype.clear = function () {
            this.x = this.y = this.z = this.w = 0.;
            return this;
        };
        ...
        /** inline */ Vec4.prototype.dot = function (v4fVec) {
        ...
        /** inline */ Vec4.prototype.length = function () {
            var x = this.x, y = this.y, z = this.z, w = this.w;
            return sqrt(x * x + y * y + z * z + w * w);
        };

        /** inline */ Vec4.prototype.lengthSquare = function () {
            var x = this.x, y = this.y, z = this.z, w = this.w;
        ...
        /** inline */ Vec4.prototype.toString = function () {
