...
define(["require", "exports", "generate", "logger"], function(require, exports, __gen__, __logger__) {
    var gen = __gen__;
    ...
    var Mat3 = (function () {
        ...
        Mat3.prototype.decompose = function (q4fRotation, v3fScale) {
            ...
            var x = sqrt(pResultData[__a11]);
            var y = sqrt(pResultData[__a22]) * scaleSign;
            var z = sqrt(pResultData[__a33]);
