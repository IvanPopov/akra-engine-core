...
define(["require", "exports", "util/ReferenceCounter", "logger", "bitflags"], function(require, exports, __ReferenceCounter__, __logger__, __bf__) {
    var ReferenceCounter = __ReferenceCounter__;
    ...
    var Entity = (function (_super) {
        ...
        */
        ...
        Entity.prototype.isUpdated = function () {
            return bf.testAll(this._iStateFlags, 1 /* k_Updated */);
        };

        Entity.prototype.hasUpdatedSubNodes = function () {
            return bf.testAll(this._iStateFlags, 2 /* k_DescendantsUpdtated */);
        };

        Entity.prototype.recursiveUpdate = function () {
            if (this.update()) {
                bf.setAll(this._iStateFlags, 1 /* k_Updated */);
                // bUpdated = true;
            }

            if (this._pSibling && this._pSibling.recursiveUpdate()) {
                bf.setAll(this._iStateFlags, 4 /* k_SiblingsUpdated */);
                // bUpdated = true;
            }

            if (this._pChild && this._pChild.recursiveUpdate()) {
                bf.setAll(this._iStateFlags, 2 /* k_DescendantsUpdtated */);
                // bUpdated = true;
            }
