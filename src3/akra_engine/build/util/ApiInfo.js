...
define(["require", "exports", "Singleton", "webgl/webgl", "util/logger", "type"], function(require, exports, __Singleton__, __webgl__, __logger__, __type__) {
    ...
    var Info = (function (_super) {
        ...
        Object.defineProperty(Info.prototype, "zip", {
            get: /** inline */ function () {
                return type.isDefAndNotNull(window["zip"]);
            },
            enumerable: true,
            configurable: true
        });
