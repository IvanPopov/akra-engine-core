...
define(["require", "exports", "util/Singleton", "cfg", "util/bitflags"], function(require, exports, __Singleton__, __cfg__, __bf__) {
    ...
    if (has("DEBUG")) {
        ...
        exports.logger.setLogLevel(31 /* ALL */);
