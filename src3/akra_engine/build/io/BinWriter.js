...
define(["require", "exports", "logger", "limit", "math"], function(require, exports, __logger__, __limit__, __math__) {
    /**
    * Как исполльзовать:
    ...
    */
    ...
    var Writer = (function () {
        ...
        Object.defineProperty(Writer.prototype, "byteLength", {
            get: /** inline */ function () {
        ...
        */
        Writer.prototype.string = function (str) {
            if (!isDefAndNotNull(str)) {
                this.uint32(limit.MAX_UINT32);
                return;
            }
            ...
            var arrUTF8string = Writer.rawStringToBuffer(sUTF8String);
        ...
        */
        Writer.prototype.uintX = function (iValue, iX) {
            if (isNull(iValue)) {
                iValue = 0;
            }
        ...
        * @tparam uint iValue число.
        */
        /** inline */ Writer.prototype.uint8 = function (iValue) {
            this.uintX(iValue, 8);
        };
        ...
        * @tparam uint iValue число.
        */
        /** inline */ Writer.prototype.uint16 = function (iValue) {
        ...
        * @tparam uint iValue число.
        */
        /** inline */ Writer.prototype.uint32 = function (iValue) {
        ...
        */
        /** inline */ Writer.prototype.boolean = function (bValue) {
            // LOG(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>> BOOL >>> ");
        ...
        * @tparam int iX - 8, 16, 32 количество бит.
        */
        Writer.prototype.writeArrayElementUintX = function (iValue, iX) {
            if (isNull(iValue)) {
                iValue = 0;
            }
        ...
        * @tparam int iX - 8, 16, 32 количество бит.
        */
        Writer.prototype.intX = function (iValue, iX) {
            if (isNull(iValue)) {
                iValue = 0;
            }
            ...
            // LOG("int", iX, ": ", iValue);
            logger.presume(isNumber(iValue));
            logger.presume(-Math.pow(2, iX - 1) <= iValue && iValue <= Math.pow(2, iX - 1) - 1, "Это значение не влезет в тип int" + iX);
        ...
        * @tparam uint iValue число.
        */
        /** inline */ Writer.prototype.int8 = function (iValue) {
            this.intX(iValue, 8);
        };
        ...
        * @tparam int iValue число.
        */
        /** inline */ Writer.prototype.int16 = function (iValue) {
            this.intX(iValue, 16);
        };
        ...
        * @tparam int iValue число.
        */
        /** inline */ Writer.prototype.int32 = function (iValue) {
            this.intX(iValue, 32);
        };
        ...
        * @tparam int iX - 8, 16, 32 количество бит.
        */
        Writer.prototype.writeArrayElementIntX = function (iValue, iX) {
            if (isNull(iValue)) {
                iValue = 0;
            }
        ...
        */
        Writer.prototype.floatX = function (fValue, iX) {
            if (isNull(fValue)) {
                fValue = 0;
            }
        ...
        * @tparam float fValue число.
        */
        /** inline */ Writer.prototype.float32 = function (fValue) {
        ...
        * @tparam float fValue число.
        */
        /** inline */ Writer.prototype.float64 = function (fValue) {
        ...
        */
        Writer.prototype.stringArray = function (arrString) {
        ...
        */
        Writer.prototype.uintXArray = function (arrUint, iX) {
        ...
        */
        /** inline */ Writer.prototype.uint8Array = function (arrUint) {
        ...
        */
        /** inline */ Writer.prototype.uint16Array = function (arrUint) {
        ...
        */
        /** inline */ Writer.prototype.uint32Array = function (arrUint) {
        ...
        * @tparam int iX размер элемента в битах (8, 16, 32).
        */
        Writer.prototype.intXArray = function (arrInt, iX) {
        ...
        */
        /** inline */ Writer.prototype.int8Array = function (arrInt) {
        ...
        */
        /** inline */ Writer.prototype.int16Array = function (arrInt) {
        ...
        */
        /** inline */ Writer.prototype.int32Array = function (arrInt) {
        ...
        */
        Writer.prototype.floatXArray = function (arrFloat, iX) {
        ...
        */
        /** inline */ Writer.prototype.float32Array = function (arrFloat) {
        ...
        */
        /** inline */ Writer.prototype.float64Array = function (arrFloat) {
        ...
        * @treturn ArrayBuffer.
        */
        /** inline */ Writer.prototype.data = function () {
        ...
        * @treturn String.
        */
        Writer.prototype.dataAsString = function () {
        ...
        * @treturn Uint8Array.
        */
        Writer.prototype.dataAsUint8Array = function () {
