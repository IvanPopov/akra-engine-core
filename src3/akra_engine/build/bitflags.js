define(["require", "exports"], function(require, exports) {
    ...
    */
    exports.testBit = function (value, bit) {
        return ((value & exports.flag(bit)) != 0);
    };
    ...
    */
    exports.testAll = function (value, set) {
    ...
    * которые равны единице у @a set.
    */
    exports.testAny = function (value, set) {
        return (((value) & (set)) != 0);
    };
    ...
    */
    exports.setBit = function (value, bit, setting) {
        if (typeof setting === "undefined") { setting = true; }
        return (setting ? ((value) |= exports.flag((bit))) : exports.clearBit(value, bit));
    };

    /**
    *
    */
    exports.clearBit = function (value, bit) {
        return ((value) &= ~exports.flag((bit)));
    };

    /**
    * Выставляет бит под номером @a bit у числа @a value равным нулю
    */
    exports.setAll = function (value, set, setting) {
        if (typeof setting === "undefined") { setting = true; }
    ...
    */
    exports.clearAll = function (value, set) {
        return ((value) &= ~(set));
    };
    ...
    * которые равны единице у числа @a set
    */
    exports.equal = function (value, src) {
        value = src;
    };
    ...
    */
    exports.isEqual = function (value, src) {
        return value == src;
    };
    ...
    */
    exports.isNotEqaul = function (value, src) {
        return value != src;
    };
    ...
    * Прирасваивает числу @a value число @a src
    */
    exports.set = function (value, src) {
        value = src;
    };
    ...
    */
    exports.setFlags = function (value, src) {
        return (value |= src);
    };
    ...
    * которые равны единице у числа @a src
    */
    exports.clearFlags = function (value, src) {
        return value &= ~src;
    };
    ...
    */
    exports.totalBits = function (value) {
        return 32;
    };
    ...
    */
    exports.totalSet = function (value) {
        var count = 0;
        var total = exports.totalBits(value);
    ...
    */
    ...
    exports.fixedToFixed = fixedToFixed;
    ...
    */
    ...
    function floatToHalf(f) {
        _f32[0] = f;
        return exports.floatToHalfI(_u32[0]);
    }
    ...
    exports.floatToHalfI = floatToHalfI;
    ...
    */
    ...
    exports.halfToFloatI = halfToFloatI;
});
