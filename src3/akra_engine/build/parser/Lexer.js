...
define(["require", "exports", "logger"], function(require, exports, __logger__) {
    ...
    var UNKNOWN_TOKEN = symbols.UNKNOWN_TOKEN;
    var EOF = symbols.EOF;

    var T_STRING = symbols.T_STRING;
    var T_FLOAT = symbols.T_FLOAT;
    var T_UINT = symbols.T_UINT;

    var T_TYPE_ID = symbols.T_TYPE_ID;
    var T_NON_TYPE_ID = symbols.T_NON_TYPE_ID;
