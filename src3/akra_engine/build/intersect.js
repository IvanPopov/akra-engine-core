define(["require", "exports", "math", "geometry/Sphere", "geometry/Circle", "geometry/Plane2d", "geometry/Plane3d", "geometry/Rect2d", "geometry/Ray2d", "geometry/Ray3d"], function(require, exports, __math__, __Sphere__, __Circle__, __Plane2d__, __Plane3d__, __Rect2d__, __Ray2d__, __Ray3d__) {
    ...
    exports.plane2dRay2d = plane2dRay2d;
    ...
    exports.plane3dRay3d = plane3dRay3d;
    ...
    exports.circleRay2d = circleRay2d;
    ...
    exports.sphereRay3d = sphereRay3d;
    ...
    exports.intersectRect2dRay2d = intersectRect2dRay2d;
    ...
    exports.intersectRect3dRay3d = intersectRect3dRay3d;
    ...
    exports.intersectRect2dCircle = intersectRect2dCircle;
    ...
    exports.intersectRect3dSphere = intersectRect3dSphere;
    ...
    exports.intersectRect2dRect2d = intersectRect2dRect2d;
    ...
    exports.intersectRect3dRect3d = intersectRect3dRect3d;
    ...
    function intersect(pRect1, pRect2, pResult) {
        ...
        if (nArgumentsLength === 3) {
            if (arguments[2] instanceof Rect2d) {
                return exports.intersectRect2dRect2d(arguments[0], arguments[1], arguments[2]);
            } else {
                return exports.intersectRect3dRect3d(arguments[0], arguments[1], arguments[2]);
            }
        } else {
            ...
            if (pArg1 instanceof Ray2d) {
                if (pArg0 instanceof Plane2d) {
                    return exports.plane2dRay2d(pArg0, pArg1);
                } else if (pArg0 instanceof Circle) {
                    return exports.circleRay2d(pArg0, pArg1);
                } else {
                    return exports.intersectRect2dRay2d(pArg0, pArg1);
                }
            } else if (pArg1 instanceof Ray3d) {
                if (pArg0 instanceof Plane3d) {
                    return exports.plane3dRay3d(pArg0, pArg1);
                } else if (pArg0 instanceof Sphere) {
                    return exports.sphereRay3d(pArg0, pArg1);
                } else {
                    return exports.intersectRect3dRay3d(pArg0, pArg1);
                }
            } else if (pArg1 instanceof Circle) {
                if (pArg0 instanceof Circle) {
                    return exports.circleCircle(pArg0, pArg1);
                } else {
                    return exports.intersectRect2dCircle(pArg0, pArg1);
                }
            } else if (pArg1 instanceof Sphere) {
                if (pArg0 instanceof Sphere) {
                    return exports.sphereSphere(pArg0, pArg1);
                } else {
                    return exports.intersectRect3dSphere(pArg0, pArg1);
                }
            } else {
                if (pArg0 instanceof Rect2d) {
                    return exports.intersectRect2dRect2d(pArg0, pArg1);
                } else {
                    return exports.intersectRect3dRect3d(pArg0, pArg1);
                }
            }
        }
    }
