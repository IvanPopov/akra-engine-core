...
define(["require", "exports", "fx/Instruction", "fx/ExprInstruction", "fx/Effect"], function(require, exports, __Instruction__, __ExprInstruction__, __Effect__) {
    ...
    var InitExprInstruction = (function (_super) {
        ...
        InitExprInstruction.prototype.optimizeForVariableType = function (pType) {
            if ((pType.isNotBaseArray() && pType._getScope() === 0) || (pType.isArray() && this._nInstructions > 1)) {
                if (pType.getLength() === Instruction.UNDEFINE_LENGTH || (pType.isNotBaseArray() && this._nInstructions !== pType.getLength()) || (!pType.isNotBaseArray() && this._nInstructions !== pType.getBaseType().getLength())) {
                    return false;
                }
        ...
        InitExprInstruction.prototype.evaluate = function () {
            ...
            if (this._isArray) {
                ...
                var pJSTypeCtor = Effect.getExternalType(this._pConstructorType);
