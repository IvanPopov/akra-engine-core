...
define(["require", "exports", "webgl", "fx/Effect", "stringUtils/StringDictionary", "fx/DeclInstruction", "fx/IdInstruction", "fx/IdExprInstruction", "fx/PostfixPointInstruction", "fx/ExtractExprInstruction", "fx/VariableTypeInstruction"], function(require, exports, __webgl__, __Effect__, __StringDictionary__, __DeclInstruction__, __IdInstruction__, __IdExprInstruction__, __PostfixPointInstruction__, __ExtractExprInstruction__, __VariableTypeInstruction__) {
    var webgl = __webgl__;

    var Effect = __Effect__;
    var StringDictionary = __StringDictionary__;
