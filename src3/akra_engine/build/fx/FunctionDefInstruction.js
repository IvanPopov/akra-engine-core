...
define(["require", "exports", "fx/DeclInstruction", "fx/Effect"], function(require, exports, __DeclInstruction__, __Effect__) {
            ...
            for (var i = 0; i < pArguments.length; i++) {
                ...
                if (!isStartAnalyze) {
                    if (pParam.getSemantic() === "") {
                        ...
                        if (pParam.getType().isStrictPointer() || pParam.getType()._containPointer() || pParam.getType()._containSampler() || Effect.isSamplerType(pParam.getType())) {
