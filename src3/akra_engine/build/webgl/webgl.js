...
define(["require", "exports", "webgl/webgl", "util/logger", "util/bitflags", "math/math", "pixelUtil/pixelUtil"], function(require, exports, __webgl__, __logger__, __bf__, __math__, __pixelUtil__) {
    var webgl = __webgl__;
    ...
    function getClosestAkraFormat(iGLFormat, iGLDataType) {
        switch (iGLFormat) {
            case 35841 /* COMPRESSED_RGB_PVRTC_2BPPV1_IMG */:
                return webgl.hasExtension(exports.WEBGL_COMPRESSED_TEXTURE_PVRTC) ? 38 /* PVRTC_RGB2 */ : 12 /* A8R8G8B8 */;
            case 35843 /* COMPRESSED_RGBA_PVRTC_2BPPV1_IMG */:
                return webgl.hasExtension(exports.WEBGL_COMPRESSED_TEXTURE_PVRTC) ? 39 /* PVRTC_RGBA2 */ : 12 /* A8R8G8B8 */;
            case 35840 /* COMPRESSED_RGB_PVRTC_4BPPV1_IMG */:
                return webgl.hasExtension(exports.WEBGL_COMPRESSED_TEXTURE_PVRTC) ? 40 /* PVRTC_RGB4 */ : 12 /* A8R8G8B8 */;
            case 35842 /* COMPRESSED_RGBA_PVRTC_4BPPV1_IMG */:
                return webgl.hasExtension(exports.WEBGL_COMPRESSED_TEXTURE_PVRTC) ? 41 /* PVRTC_RGBA4 */ : 12 /* A8R8G8B8 */;
            ...
            case 33777 /* COMPRESSED_RGBA_S3TC_DXT1_EXT */:
                return webgl.hasExtension(exports.WEBGL_COMPRESSED_TEXTURE_S3TC) ? 17 /* DXT1 */ : 12 /* A8R8G8B8 */;

            case 33778 /* COMPRESSED_RGBA_S3TC_DXT3_EXT */:
                return webgl.hasExtension(exports.WEBGL_COMPRESSED_TEXTURE_S3TC) ? 19 /* DXT3 */ : 12 /* A8R8G8B8 */;
            case 33779 /* COMPRESSED_RGBA_S3TC_DXT5_EXT */:
                return webgl.hasExtension(exports.WEBGL_COMPRESSED_TEXTURE_S3TC) ? 21 /* DXT5 */ : 12 /* A8R8G8B8 */;

            case 33321 /* R8_EXT */:
                return webgl.hasExtension(exports.EXT_TEXTURE_RG) ? 42 /* R8 */ : 12 /* A8R8G8B8 */;
            case 33323 /* RG8_EXT */:
                return webgl.hasExtension(exports.EXT_TEXTURE_RG) ? 43 /* RG8 */ : 12 /* A8R8G8B8 */;
