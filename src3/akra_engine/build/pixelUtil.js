...
define(["require", "exports", "bitflags", "math", "pixelUtil/PixelBox", "logger"], function(require, exports, __bf__, __math__, __PixelBox__, __logger__) {
    ...
    function getDescriptionFor(eFmt) {
        var ord = eFmt;
        logger.assert(ord >= 0 && ord < 48 /* TOTAL */, "getDescriptionFor:" + ord);
    ...
    */
    ...
    function bulkPixelConversion(pSrc, eSrcFormat, pDest, eDstFormat, iCount) {
        ...
        if ((src.format == 26 /* X8R8G8B8 */ || src.format == 27 /* X8B8G8R8 */) && !exports.hasAlpha(dst.format)) {
            // Do the same conversion, with AEPixelFormats.A8R8G8B8, which has a lot of
            // optimized conversions
            var tempsrc = src;
