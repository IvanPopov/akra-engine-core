...
import PackerTemplate = require("io/PackerTemplate");

var pCommonTemplate: AIPackerTemplate  = new PackerTemplate;

pCommonTemplate.set(<AIPackerFormat><any>{
    "Float32Array": {
