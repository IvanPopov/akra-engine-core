...
/// <reference path="AIDocument.ts" />


/// <reference path="AIAnimationTrack.ts" />
/// <reference path="AIAnimation.ts" />
/// <reference path="AIAnimationBlend.ts" />
/// <reference path="AIAnimationContainer.ts" />
...
module akra.io {
	...
	class Exporter {
		...
		protected makeEntry(eType: EDocumentEntry, pData: AIUnique): void {
		...
		protected encodeAnimationBaseEntry(pAnimation: AIAnimationBase): IDataEntry {
		...
		protected encodeAnimationFrameEntry(pFrame: AIPositionFrame): IAnimationFrameEntry {
		...
		protected encodeAnimationTrack(pTrack: AIAnimationTrack): IAnimationTrackEntry {
			...
			for (var i: int = 0; i < pTrack.totalFrames; ++ i) {
				var pFrame: IAnimationFrameEntry = this.encodeAnimationFrameEntry(<AIPositionFrame>pTrack.getKeyFrame(i));
		...
		protected encodeAnimationEntry(pAnimation: AIAnimation): IDataEntry {
		...
		protected encodeAnimationContainerEntry(pContainer: AIAnimationContainer): IDataEntry {
		...
		protected encodeAnimationBlendEntry(pBlend: AIAnimationBlend): IDataEntry {
		...
		protected encodeControllerEntry(pController: AIAnimationController): IDataEntry {
