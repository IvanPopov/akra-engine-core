...
class Writer implements AIBinWriter {
    /**
    ...
    string(str: string): void {
        ...
        var arrUTF8string: Uint8Array = Writer.rawStringToBuffer(sUTF8String);
     ...
     * @tparam uint iValue число.
     */
    /** inline */ uint16(iValue: uint): void {
     ...
     * @tparam uint iValue число.
     */
    /** inline */ uint32(iValue: uint): void {
     ...
     */
    /** inline */ boolean(bValue: boolean): void {
        // LOG(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>> BOOL >>> ");
