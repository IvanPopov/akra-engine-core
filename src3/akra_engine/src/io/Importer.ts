...
module akra.io {
	class Importer {
		...
		getController(iContrller: int = 0): AIAnimationController {
			return <AIAnimationController>this.decodeEntry(this.findEntryByIndex(EDocumentEntry.k_Controller, iContrller).entry);
		}
		...
		protected decodeAnimationFrame(pEntry: IAnimationFrameEntry): AIPositionFrame {
		...
		protected decodeAnimationTrack(pEntry: IAnimationTrackEntry): AIAnimationTrack {
		...
		protected decodeAnimationEntry(pEntry: IAnimationEntry): AIAnimation {
		...
		protected decodeAnimationBlendEntry(pEntry: IAnimationBlendEntry): AIAnimationBlend {
		...
		protected decodeAnimationContainerEntry(pEntry: IAnimationContainerEntry): AIAnimationContainer {
		...
		protected decodeControllerEntry(pEntry: IControllerEntry): AIAnimationController {
