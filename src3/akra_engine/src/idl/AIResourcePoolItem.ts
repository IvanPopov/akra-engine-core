...
interface AIResourcePoolItem extends AIReferenceCounter, AIEventProvider {
	/** resource code */
	/** readonly */ resourceCode: AIResourceCode;
	/** resource pool */
	/** readonly */ resourcePool: AIResourcePool;
	/** resource handle */
	...
	/** Get current Engine. */
	getEngine(): AIEngine;
	getManager(): AIResourcePoolManager;
	...
	setStateWatcher(eEvent: AEResourceItemEvents, fnWatcher: AIResourceWatcherFunc): void;

	/** sinchronize events with other resourse */
	isSyncedTo(eSlot: AEResourceItemEvents): boolean;
	//sync(pResourceItem: AIResourcePoolItem, sSignal: string, sSlot?: string): boolean;
	sync(pResourceItem: AIResourcePoolItem, eSignal: AEResourceItemEvents, eSlot?: AEResourceItemEvents): boolean;

	//unsync(pResourceItem: AIResourcePoolItem, sSignal: string, sSlot?: string): boolean;
	unsync(pResourceItem: AIResourcePoolItem, eSignal: AEResourceItemEvents, eSlot?: AEResourceItemEvents): boolean;
	...
	notifyStateChange(eEvent: AEResourceItemEvents, pTarget?: AIResourcePoolItem);
	...
	setResourceCode(pCode: AIResourceCode): void;
	setResourcePool(pPool: AIResourcePool): void;
	setResourceHandle(iHandle: int): void;

	setResourceFlag(eFlagBit: AEResourceItemEvents, isSetting: boolean): boolean;
...
interface AIResourcePoolItemType {
	new (pManager: AIResourcePoolManager): AIResourcePoolItem;
}
