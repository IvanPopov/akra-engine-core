...
class GamepadMap implements AIGamepadMap {
    private _bTicking: boolean = false;
    private _pCollection: AIObjectArray<Gamepad> = new ObjectArray<Gamepad>();
    ...
    init(): boolean {
        ...
        var pCollection: AIObjectArray<Gamepad> = this._pCollection;
