...
class IdInstruction extends Instruction implements AIAFXIdInstruction {
    ...
    constructor() {
        ...
        this._sName = "";
        this._sRealName = "";
        this._eInstructionType = AEAFXInstructionTypes.k_IdInstruction;
    }
    ...
    clone(pRelationMap?: AIAFXInstructionMap): IdInstruction {
