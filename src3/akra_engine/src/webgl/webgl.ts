...
import webgl = require("webgl/webgl");
import logger = require("util/logger");
import type = require("type");
import bf = require("util/bitflags");
import math = require("math/math");
import pixelUtil = require("pixelUtil/pixelUtil");

import isDef = type.isDef;
import isDefAndNotNull = type.isDefAndNotNull;
import isFunction = type.isFunction;
...
export function getClosestAkraFormat(iGLFormat: int, iGLDataType: int): AEPixelFormats {
    switch (iGLFormat) {
        ...
        case gl.COMPRESSED_RGB_PVRTC_2BPPV1_IMG:
            return webgl.hasExtension(WEBGL_COMPRESSED_TEXTURE_PVRTC) ? AEPixelFormats.PVRTC_RGB2 : AEPixelFormats.A8R8G8B8;
        case gl.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG:
            return webgl.hasExtension(WEBGL_COMPRESSED_TEXTURE_PVRTC) ? AEPixelFormats.PVRTC_RGBA2 : AEPixelFormats.A8R8G8B8;
        case gl.COMPRESSED_RGB_PVRTC_4BPPV1_IMG:
            return webgl.hasExtension(WEBGL_COMPRESSED_TEXTURE_PVRTC) ? AEPixelFormats.PVRTC_RGB4 : AEPixelFormats.A8R8G8B8;
        case gl.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG:
            return webgl.hasExtension(WEBGL_COMPRESSED_TEXTURE_PVRTC) ? AEPixelFormats.PVRTC_RGBA4 : AEPixelFormats.A8R8G8B8;
        ...
        case gl.COMPRESSED_RGBA_S3TC_DXT1_EXT:
            return webgl.hasExtension(WEBGL_COMPRESSED_TEXTURE_S3TC) ? AEPixelFormats.DXT1 : AEPixelFormats.A8R8G8B8;

        case gl.COMPRESSED_RGBA_S3TC_DXT3_EXT:
            return webgl.hasExtension(WEBGL_COMPRESSED_TEXTURE_S3TC) ? AEPixelFormats.DXT3 : AEPixelFormats.A8R8G8B8;
        case gl.COMPRESSED_RGBA_S3TC_DXT5_EXT:
            return webgl.hasExtension(WEBGL_COMPRESSED_TEXTURE_S3TC) ? AEPixelFormats.DXT5 : AEPixelFormats.A8R8G8B8;

        case gl.R8_EXT:
            return webgl.hasExtension(EXT_TEXTURE_RG) ? AEPixelFormats.R8 : AEPixelFormats.A8R8G8B8;
        case gl.RG8_EXT:
            return webgl.hasExtension(EXT_TEXTURE_RG) ? AEPixelFormats.RG8 : AEPixelFormats.A8R8G8B8;
