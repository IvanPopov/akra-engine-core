...
class Quat4 implements AIQuat4 {
    x: float;
    y: float;
    z: float;
    w: float;
    ...
    set(): AIQuat4;
    set(q: AIQuat4): AIQuat4;
    set(q: float[]): AIQuat4;
    set(xyz: float, w: float): AIQuat4;
    set(xyz: AIVec3, w: float): AIQuat4;
    set(x: float, y: float, z: float, w: float): AIQuat4;
    set(x?, y?, z?, w?): AIQuat4 {
        var nArgumentsLength: uint = arguments.length;
        ...
        if (nArgumentsLength === 1) {
            if (arguments[0] instanceof Quat4) {
                var q4fQuat: AIQuat4 = arguments[0];
            ...
            if (isFloat(arguments[0])) {
                ...
                //vec3 float
                var v3fValue: AIVec3 = arguments[0];
    ...
    multiplyVec3(v3fVec: AIVec3, v3fDestination?: AIVec3): AIVec3 {
        ...
        var q4fVec: AIQuat4 = Quat4.temp(v3fVec, 0.);
        var qInverse: AIQuat4 = this.inverse(Quat4.temp());
        var qResult: AIQuat4 = this.multiply(q4fVec.multiply(qInverse), Quat4.temp());
    ...
    isEqual(q4fQuat: AIQuat4, fEps: float = 0., asMatrix: boolean = false): boolean {
    ...
    mix(q4fQuat: AIQuat4, fA: float, q4fDestination?: AIQuat4, bShortestPath: boolean = true) {
        if (!isDef(q4fDestination)) {
            q4fDestination = this;
        }
    ...
    smix(q4fQuat: AIQuat4, fA: float, q4fDestination?: AIQuat4, bShortestPath: boolean = true) {
        if (!isDef(q4fDestination)) {
            q4fDestination = this;
        }
    ...
    static fromForwardUp(v3fForward: AIVec3, v3fUp: AIVec3, q4fDestination?: AIQuat4): AIQuat4 {
        if (!isDef(q4fDestination)) {
    ...
    static fromAxisAngle(v3fAxis: AIVec3, fAngle: float, q4fDestination?: AIQuat4): AIQuat4 {
    ...
    static fromYawPitchRoll(fYaw: float, fPitch: float, fRoll: float, q4fDestination?: AIQuat4): AIQuat4;
    static fromYawPitchRoll(v3fAngles: AIVec3, q4fDestination?: AIQuat4): AIQuat4;
    static fromYawPitchRoll(fYaw?, fPitch?, fRoll?, q4fDestination?): AIQuat4 {
    ...
    static fromXYZ(fX: float, fY: float, fZ: float, q4fDestination?: AIQuat4): AIQuat4;
    static fromXYZ(v3fAngles: AIVec3, q4fDestination?: AIQuat4): AIQuat4;
    static fromXYZ(fX?, fY?, fZ?, q4fDestination?): AIQuat4 {
        if (arguments.length <= 2) {
            //Vec3 + m4fDestination
            var v3fVec: AIVec3 = arguments[0];
    ...
    static temp(): AIQuat4;
    static temp(q: AIQuat4): AIQuat4;
    static temp(q: float[]): AIQuat4;
    static temp(xyz: float, w: float): AIQuat4;
    static temp(xyz: AIVec3, w: float): AIQuat4;
    static temp(x: float, y: float, z: float, w: float): AIQuat4;
    static temp(x?, y?, z?, w?): AIQuat4 {
...
pBuffer = gen.array<AIQuat4>(256, Quat4);
iElement = 0;
