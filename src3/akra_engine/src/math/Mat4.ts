...
class Mat4 implements AIMat4 {
    data: Float32Array;

    constructor();
    constructor(f: float);
    constructor(v: AIVec4);
    constructor(m: AIMat3, v?: AIVec3);
    constructor(m: AIMat4);
    constructor(p: float[]);
    /** 
     * Use a pointer or copy.
     */
    constructor(p: Float32Array, bFlag: boolean);
    constructor(f1: float, f2: float,
        f3: float, f4: float);
    constructor(v4fVec1: AIVec4, v4fVec2: AIVec4,
        v4fVec3: AIVec4, v4fVec4: AIVec4);
    constructor(
        p1: float[],
        p2: float[],
        p3: float[],
    ...
    set(): AIMat4;
    set(f: float): AIMat4;
    set(v4: AIVec4): AIMat4;
    set(m3: AIMat3, v3?: AIVec3): AIMat4;
    set(m4: AIMat4): AIMat4;
    set(p: float[]): AIMat4;
    set(f1: float, f2: float,
        f3: float, f4: float): AIMat4;
    set(v1: AIVec4, v2: AIVec4,
        v3: AIVec4, v4: AIVec4): AIMat4;
    set(p1: float[], p2: float[],
        p3: float[], p4: float[]): AIMat4;
    set(f1: float, f2: float, f3: float, f4: float,
        f5: float, f6: float, f7: float, f8: float,
        f9: float, f10: float, f11: float, f12: float,
        f13: float, f14: float, f15: float, f16: float): AIMat4;
    set(
        f1?, f2?, f3?, f4?,
        f5?, f6?, f7?, f8?,
        f9?, f10?, f11?, f12?,
        f13?, f14?, f15?, f16?): AIMat4 {
        ...
        if (nArgumentsLength === 1) {
            ...
            var v3fTranslation: AIVec3 = arguments[1];
            ...
            if (isFloat(arguments[0])) {
                ...
                var v4fColumn1: AIVec4 = arguments[0];
                var v4fColumn2: AIVec4 = arguments[1];
                var v4fColumn3: AIVec4 = arguments[2];
                var v4fColumn4: AIVec4 = arguments[3];
                ...
                var pColumn1: float[] = arguments[0];
                var pColumn2: float[] = arguments[1];
                var pColumn3: float[] = arguments[2];
                var pColumn4: float[] = arguments[3];
    ...
    /** inline */ multiplyLeft(m4fMat: AIMat4, m4fDestination?: AIMat4): AIMat4 {
        if (!isDef(m4fDestination)) {
            m4fDestination = this;
        }
    ...
    isEqual(m4fMat: AIMat4, fEps: float = 0.): boolean {
        var pData1: Float32Array = this.data;
        var pData2: Float32Array = m4fMat.data;
    ...
    toQuat4(q4fDestination?: AIQuat4) {
    ...
    toArray(pDest: float[]= new Array(16)): float[] {
        //TODO: too slow :(
        return conv.retrieve<Float32Array, float[]>(this.data, pDest, 1, 0, 16) && pDest;
    }
    ...
    /** inline */ setTranslation(v3fTranslation: AIVec3): AIMat4 {
        var pData: Float32Array = this.data;
    ...
    /** inline */ getTranslation(v3fTranslation?: AIVec3): AIVec3 {
    ...
    /** inline */ decompose(q4fRotation: AIQuat4, v3fScale: AIVec3, v3fTranslation: AIVec3): boolean {
    ...
    unproj(v: any, v4fDestination?: AIVec4): AIVec4 {
        if (!isDef(v4fDestination)) {
            v4fDestination = new Vec4();
        }

        var pData: Float32Array = this.data;
        var v3fScreen: AIVec3 = <AIVec3>v;
    ...
    /** inline */ isOrthogonalProjection(): boolean {
        // var pData: Float32Array = this.data;
    ...
    static fromYawPitchRoll(fYaw: float, fPitch: float, fRoll: float, m4fDestination?: AIMat4): AIMat4;
    static fromYawPitchRoll(v3fAngles: AIVec3, m4fDestination?: AIMat4): AIMat4;
    static fromYawPitchRoll(): AIMat4 {
        var fYaw: float = 0.0,
            fPitch: float = 0.0,
            fRoll: float = 0.0,
            m4fDestination: AIMat4 = null;
    ...
    static fromXYZ(fX: float, fY: float, fZ: float, m4fDestination?: AIMat4): AIMat4;
    static fromXYZ(v3fAngles: AIVec3, m4fDestination?: AIMat4): AIMat4;
    static fromXYZ(fX?, fY?, fZ?, m4fDestination?): AIMat4 {
        if (arguments.length <= 2) {
            //Vec3 + m4fDestination
            var v3fVec: AIVec3 = arguments[0];
    ...
    static frustum(fLeft: float, fRight: float, fBottom: float, fTop: float, fNear: float, fFar: float, m4fDestination?: AIMat4): AIMat4 {
        if (!isDef(m4fDestination)) {
            m4fDestination = new Mat4();
        }
    ...
    /** inline */ static perspective(fFovy: float, fAspect: float, fNear: float, fFar: float, m4fDestination?: AIMat4): AIMat4 {
    ...
    static orthogonalProjectionAsymmetric(fLeft: float, fRight: float, fBottom: float,
        fTop: float, fNear: float, fFar: float, m4fDestination?: AIMat4): AIMat4 {
    ...
    /** inline */ static orthogonalProjection(fWidth: float, fHeight: float, fNear: float, fFar: float, m4fDestination?: AIMat4): AIMat4 {
    ...
    static lookAt(v3fEye: AIVec3, v3fCenter: AIVec3, v3fUp: AIVec3, m4fDestination?: AIMat4): AIMat4 {
        if (!isDef(m4fDestination)) {
    ...
    static temp(): AIMat4;
    static temp(f: float): AIMat4;
    static temp(v4: AIVec4): AIMat4;
    static temp(m3: AIMat3, v3?: AIVec3): AIMat4;
    static temp(m4: AIMat4): AIMat4;
    static temp(p: float[]): AIMat4;
    static temp(
        f11: float,
        f22: float,
        f33: float,
    ...
    static temp(
        ...
        vColumn2: AIVec4,
        vColumn3: AIVec4,
        vColumn4: AIVec4): AIMat4;
    static temp(
        pColumn1: float[],
        pColumn2: float[],
        pColumn3: float[],
        pColumn4: float[]): AIMat4;
    static temp(
        f1: float, f2: float, f3: float, f4: float,
        f5: float, f6: float, f7: float, f8: float,
        f9: float, f10: float, f11: float, f12: float,
...
pBuffer = gen.array<AIMat4>(256, Mat4);
iElement = 0;
