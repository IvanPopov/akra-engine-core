            ...
            Progress.prototype.render = function () {
                ...
                if (akra.isNull(this.element)) {
                    ...
                    if (this.element instanceof HTMLCanvasElement) {
                        ...
                        el.setAttribute("style", "position: absolute; z-index: 9999; left: " + (x + this.element.offsetWidth / 2. - el.offsetWidth / 2.) + "px; top: " + (y + this.element.offsetHeight / 2. - el.offsetHeight / 2.) + "px;");
                    } else {
