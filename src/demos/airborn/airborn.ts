...
module akra {
	...
	function createLighting(): void {
		...
		//				(<IMesh>node.getMesh()).setShadow(false);
		//			}
		//		})
	...
	function createOcean(): ISceneModel {
		var pOceanQuad: ISceneModel = addons.createQuad(pScene, 500, new math.Vec2(5000, 5000));
		var pTexture: ITexture = pRmgr.createTexture("water_texture");
	...
	function main(pEngine: IEngine) {
		...
		createSkyBox();
		window["ocean"] = createOcean().setPosition(0, -10, 0);
