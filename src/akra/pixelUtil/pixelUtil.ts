...
module akra.pixelUtil {
	...
	export /**  */ function getDescriptionFor(eFmt: EPixelFormats): IPixelFormatDescription {
	...
	*/
	export /**  */ function getNumElemBytes(eFormat: EPixelFormats): uint {
	...
	*/
	export /**  */ function getNumElemBits(eFormat: EPixelFormats): uint {
	...
	*/
	export  /**  */ function getFlags(eFormat: EPixelFormats): uint {
		return getDescriptionFor(eFormat).flags;
	}

	/** Shortcut method to determine if the format has an alpha component */
	export /**  */ function hasAlpha(eFormat: EPixelFormats): boolean {
		return (getFlags(eFormat) & EPixelFormatFlags.HASALPHA) > 0;
	}
	/** Shortcut method to determine if the format is floating point */
	export /**  */ function isFloatingPoint(eFormat: EPixelFormats): boolean {
		return (getFlags(eFormat) & EPixelFormatFlags.FLOAT) > 0;
	}
	/** Shortcut method to determine if the format is compressed */
	export /**  */ function isCompressed(eFormat: EPixelFormats): boolean {
		return (getFlags(eFormat) & EPixelFormatFlags.COMPRESSED) > 0;
	}
	/** Shortcut method to determine if the format is a depth format. */
	export /**  */ function isDepth(eFormat: EPixelFormats): boolean {
		return (getFlags(eFormat) & EPixelFormatFlags.DEPTH) > 0;
	}
	/** Shortcut method to determine if the format is in native endian format. */
	export /**  */ function isNativeEndian(eFormat: EPixelFormats): boolean {
		return (getFlags(eFormat) & EPixelFormatFlags.NATIVEENDIAN) > 0;
	}
	/** Shortcut method to determine if the format is a luminance format. */
	export /**  */ function isLuminance(eFormat: EPixelFormats): boolean {
	...
	*/
	export function isValidExtent(iWidth: uint, iHeight: uint, iDepth: uint, eFormat: EPixelFormats): boolean {
		if (isCompressed(eFormat)) {
			switch (eFormat) {
				case EPixelFormats.DXT1:
				case EPixelFormats.DXT2:
	...
	*/
	export /**  */ function getFormatName(eSrcFormat: EPixelFormats): string {
	...
	*/
	export function isAccessible(eSrcFormat: EPixelFormats): boolean {
	...
	*/
	export /**  */ function getComponentType(eFmt: EPixelFormats): EPixelComponentTypes {
	 ...
	 */
	export /**  */ function getComponentCount(eFmt: EPixelFormats): uint {
		return getDescriptionFor(eFmt).componentCount;
	}

	export /**  */ function getComponentTypeBits(eFormat: EPixelFormats): uint {
	...
	*/
	export function getFormatFromName(sName: string, isAccessibleOnly: boolean = false, isCaseSensitive: boolean = false): EPixelFormats {
	...
	*/
	export function getBNFExpressionOfPixelFormats(isAccessibleOnly: boolean = false): string {
		...
		var formatNames: IPair<uint, string>[] = [];
	...
	*/
	export function packColour(cColour: IColor, ePf: EPixelFormats, pDest: Uint8Array): void {
	...
	*/
	...
	export function bulkPixelConversion(pSrc: any, eSrcFormat: any, pDest?: any, eDstFormat?: any, iCount?: uint): void {
		...
		if (src.format == dst.format) {
			...
			/** @const */ var rowSize: uint = src.getWidth() * srcPixelSize;
