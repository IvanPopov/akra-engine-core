declare module TypeScript {
	var DiagnosticCode: {
		...
		Enable_strict_checking_of_numeric_types: string;
		Numeric_type_0_not_strict_equal_to_1: string;
		Numeric_type_0_is_not_specified: string;
		Numeric_type_0_is_not_integer: string;
		Type_of_variable_is_number: string;
		Type_of_variable_init_is_number: string;
	};
}
declare module TypeScript {
...
declare module TypeScript.Syntax {
	interface IFactory {
		...
		methodSignature(modifiersToken: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, questionToken: TypeScript.ISyntaxToken, callSignature: TypeScript.CallSignatureSyntax): TypeScript.MethodSignatureSyntax;
	...
	class NormalModeFactory implements IFactory {
		...
		public methodSignature(modifiersToken: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, questionToken: TypeScript.ISyntaxToken, callSignature: TypeScript.CallSignatureSyntax): TypeScript.MethodSignatureSyntax;
...
declare module TypeScript {
	...
	class MethodSignatureSyntax extends TypeScript.SyntaxNode implements TypeScript.ITypeMemberSyntax {
		public modifiersToken: TypeScript.ISyntaxToken;
		public propertyName: TypeScript.ISyntaxToken;
		public questionToken: TypeScript.ISyntaxToken;
		public callSignature: CallSignatureSyntax;
		constructor(modifiersToken: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, questionToken: TypeScript.ISyntaxToken, callSignature: CallSignatureSyntax, parsedInStrictMode: boolean);
		public accept(visitor: TypeScript.ISyntaxVisitor): any;
		public kind(): TypeScript.SyntaxKind;
		public childCount(): number;
		public childAt(slot: number): TypeScript.ISyntaxElement;
		public isTypeMember(): boolean;
		public update(modifiersToken: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, questionToken: TypeScript.ISyntaxToken, callSignature: CallSignatureSyntax): MethodSignatureSyntax;
		...
		public withModifiersToken(modifiersToken: TypeScript.ISyntaxToken): MethodSignatureSyntax;
...
declare module TypeScript {
	...
	class PullTypeSymbol extends PullSymbol {
		...
		public isUintType(): boolean;
		public isFloatType(): boolean;
		public isUnspecifiedNumberType(): boolean;
		public isIntNumericLiteral(): boolean;
		public isType(): boolean;
...
declare module TypeScript {
	...
	class SemanticInfoChain {
		...
		public akraIntTypeSymbol: TypeScript.PullTypeSymbol;
		public akraFloatTypeSymbol: TypeScript.PullTypeSymbol;
		public akraUintTypeSymbol: TypeScript.PullTypeSymbol;
		public akraIntNumericLiteralTypeSymbol: TypeScript.PullTypeSymbol;
...
declare module TypeScript.PullHelpers {
	...
	function isNumberType(pType: TypeScript.PullTypeSymbol): boolean;
	function isStrictEqualsNumberTypes(pTypeA: TypeScript.PullTypeSymbol, pTypeB: TypeScript.PullTypeSymbol): boolean;
}
declare module TypeScript {
	class SyntaxTreeToAstVisitor implements TypeScript.ISyntaxVisitor {
		...
		public visitExternalModuleReference(node: TypeScript.ExternalModuleReferenceSyntax): any;
		public visitModuleNameModuleReference(node: TypeScript.ModuleNameModuleReferenceSyntax): any;
		private _currentClassHasEvents;
...
declare module TypeScript {
	...
	class NumberLiteral extends AST {
		public value: number;
		private _text;
		public isAkraFloatType: boolean;
