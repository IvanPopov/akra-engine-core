    ...
    (function (ui) {
        ...
        var HTMLNode = (function (_super) {
            ...
            function HTMLNode(parent, pElement, eNodeType) {
                ...
                _super.call(this, akra.ui.getUI(parent), eNodeType);
                this.$element = null;
    ...
    (function (ui) {
        var DNDNode = (function (_super) {
            ...
            function DNDNode(parent, element, eNodeType) {
                ...
                _super.call(this, akra.ui.getUI(parent), element, eNodeType);
    ...
    (function (ui) {
        ...
        var Component = (function (_super) {
            ...
            function Component(parent, options, eType, $el) {
                ...
                _super.call(this, akra.ui.getUI(parent), $el, 4 /* COMPONENT */);
            ...
            Component.prototype.getLayout = function () {
                return akra.ui.isLayout(this.getChild()) ? this.getChild() : null;
            };
            ...
            Component.prototype.setLayout = function (type) {
                ...
                if (akra.ui.isLayout(this.getChild())) {
            ...
            Component.prototype.attachToParent = function (pParent, bRender) {
                if (typeof bRender === "undefined") { bRender = true; }
                if (isComponent(pParent) && akra.ui.isLayout(pParent.getChild()) && !akra.ui.isLayout(pParent)) {
        ...
        function isComponent(pEntity, eComponent) {
            if (!akra.ui.isUINode(pEntity) || pEntity.getNodeType() !== 4 /* COMPONENT */) {
                return false;
            }
    ...
    (function (ui) {
        var Panel = (function (_super) {
            ...
            function Panel(parent, options, eType) {
                ...
                _super.call(this, parent, akra.ui.mergeOptions({ layout: 0 /* UNKNOWN */ }, options), eType, $("<div>\
        ...
        akra.ui.register("Panel", Panel);

        function isPanel(pEntity) {
            return akra.ui.isComponent(pEntity, 4 /* PANEL */);
        }
        ui.isPanel = isPanel;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
    ...
    (function (ui) {
        ...
        var Popup = (function (_super) {
            ...
            function Popup(parent, options, eType) {
                ...
                _super.call(this, parent, akra.ui.mergeOptions({ layout: 0 /* UNKNOWN */ }, options), eType, $("<div class=\"component-popup\"><div class='header'><div class=\"title\"/><div class=\"controls\"/></div></div>"));
                this.$closeBtn = null;
    ...
    (function (ui) {
        var Tabs = (function (_super) {
            ...
            Tabs.prototype.addChild = function (pEntity) {
                akra.logger.assert(akra.ui.isPanel(pEntity), "only panels can be added to Tabs");
...
(function (akra) {
    ...
    (function (ui) {
        ...
        akra.ui.register("Button", Button);
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
})(akra || (akra = {}));
/// <reference path="Component.ts" />
    ...
    (function (ui) {
        ...
        var Menu = (function (_super) {
            ...
            function Menu(parent, options, eType) {
                ...
                _super.call(this, parent, akra.ui.mergeOptions({ layout: 2 /* VERTICAL */ }, options), eType, $("<div class=\"component-menu\">\
...
(function (akra) {
    (function (ui) {
        ...
        akra.ui.register("Switch", Switch);
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
})(akra || (akra = {}));
...
(function (akra) {
    (function (ui) {
        ...
        akra.ui.register("Vector", Vector);
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
})(akra || (akra = {}));
/// <reference path="../idl/IUILayout.ts" />
    ...
    (function (ui) {
        var Horizontal = (function (_super) {
            ...
            Horizontal.prototype.removeChild = function (pChild) {
                if (akra.ui.containsHTMLElement(pChild)) {
...
(function (akra) {
    (function (ui) {
        ...
        akra.ui.register("Slider", Slider);
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
})(akra || (akra = {}));
    ...
    (function (ui) {
        ...
        var Checkbox = (function (_super) {
            ...
            function Checkbox(parent, options, eType) {
                ...
                _super.call(this, akra.ui.getUI(parent), options, eType, $("<div><span class=\"checkbox-item-text\"></span></div>"));
        ...
        function isCheckbox(pEntity) {
            return akra.ui.isComponent(pEntity, 14 /* CHECKBOX */);
        }
        ui.isCheckbox = isCheckbox;

        akra.ui.register("Checkbox", Checkbox);
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
})(akra || (akra = {}));
/// <reference path="../idl/IUICheckboxList.ts" />
...
(function (akra) {
    (function (ui) {
        ...
        akra.ui.register("CheckboxList", CheckboxList);
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
})(akra || (akra = {}));
    ...
    (function (ui) {
        var Window = (function (_super) {
            ...
            function Window(pUI, options) {
                ...
                this.$document.find("head").append(akra.ui.$document.find("link"));
        ...
        akra.ui.register("Window", Window);
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
})(akra || (akra = {}));
/// <reference path="../../../build/akra.d.ts" />
...
(function (akra) {
    (function (ui) {
        ...
        akra.ui.register("RenderTargetStats", RenderTargetStats);
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
})(akra || (akra = {}));
        ...
        (function (scene) {
            ...
            var SceneTree = (function (_super) {
                ...
                SceneTree.prototype.select = function (pNode) {
                    if (akra.ui.ide.cmd(2 /* INSPECT_SCENE_NODE */, pNode.source)) {
            ...
            akra.ui.register("SceneTree", SceneTree);
        })(ui.scene || (ui.scene = {}));
        var scene = ui.scene;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
...
(function (akra) {
    (function (ui) {
        (function (animation) {
            ...
            akra.ui.register("animation.ColladaAnimation", ColladaAnimation);
...
(function (akra) {
    (function (ui) {
        ...
        (function (resource) {
            ...
            akra.ui.register("resource.Properties", Properties);
        ...
        (function (animation) {
            var ControllerProperties = (function (_super) {
                ...
                ControllerProperties.prototype._editController = function (pButton) {
                    akra.ui.ide.cmd(5 /* EDIT_ANIMATION_CONTROLLER */, this._pController);
                };
            ...
            akra.ui.register("AnimationControllerProperties", ControllerProperties);
        })(ui.animation || (ui.animation = {}));
        var animation = ui.animation;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
...
(function (akra) {
    (function (ui) {
        (function (model) {
            ...
            akra.ui.register("model.MeshSubsetProperties", MeshSubsetProperties);
        })(ui.model || (ui.model = {}));
        var model = ui.model;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
...
(function (akra) {
    (function (ui) {
        ...
        (function (model) {
            ...
            akra.ui.register("model.MeshProperties", MeshProperties);
        })(ui.model || (ui.model = {}));
        var model = ui.model;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
...
(function (akra) {
    (function (ui) {
        (function (light) {
            ...
            akra.ui.register("light.Properties", Properties);
        })(ui.light || (ui.light = {}));
        var light = ui.light;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
...
(function (akra) {
    (function (ui) {
        ...
        (function (scene) {
            ...
            akra.ui.register("scene.Model", Model);
        })(ui.scene || (ui.scene = {}));
        var scene = ui.scene;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
...
(function (akra) {
    (function (ui) {
        ...
        (function (animation) {
            ...
            akra.ui.register("animation.NodeProperties", NodeProperties);
        })(ui.animation || (ui.animation = {}));
        var animation = ui.animation;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
...
(function (akra) {
    (function (ui) {
        ...
        (function (animation) {
            ...
            akra.ui.register("animation.MaskProperties", MaskProperties);
        })(ui.animation || (ui.animation = {}));
        var animation = ui.animation;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
...
(function (akra) {
    (function (ui) {
        (function (animation) {
            ...
            akra.ui.register("animation.Controller", Controller);
        })(ui.animation || (ui.animation = {}));
        var animation = ui.animation;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
        ...
        (function (camera) {
            var Events = (function (_super) {
                ...
                Events.prototype._lookThrough = function (pBtn) {
                    akra.ui.ide.cmd(10 /* CHANGE_CAMERA */, this._pCamera);
                };

                Events.prototype._editPreRenderEvent = function (pBtn, e) {
                    akra.ui.ide.cmd(7 /* EDIT_EVENT */, this._pCamera, "preRenderScene");
                };

                Events.prototype._editPostRenderEvent = function (pBtn, e) {
                    akra.ui.ide.cmd(7 /* EDIT_EVENT */, this._pCamera, "postRenderScene");
                };
            ...
            akra.ui.register("camera.Events", Events);
        })(ui.camera || (ui.camera = {}));
        ...
        (function (scene) {
            var Events = (function (_super) {
                ...
                Events.prototype._editPreUpdateEvent = function (pBtn, e) {
                    akra.ui.ide.cmd(7 /* EDIT_EVENT */, this._pScene, "preUpdate");
                };

                Events.prototype._editPostUpdateEvent = function (pBtn, e) {
                    akra.ui.ide.cmd(7 /* EDIT_EVENT */, this._pScene, "postUpdate");
                };

                Events.prototype._editBeforeUpdateEvent = function (pBtn, e) {
                    akra.ui.ide.cmd(7 /* EDIT_EVENT */, this._pScene, "beforeUpdate");
                };
            ...
            akra.ui.register("scene.Events", Events);
        })(ui.scene || (ui.scene = {}));
        var scene = ui.scene;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
    ...
    (function (ui) {
        ...
        var Inspector = (function (_super) {
            ...
            function Inspector(parent, options) {
                ...
                this._pSceneEvents.setScene(akra.ui.ide.getScene());
            ...
            Inspector.prototype._addController = function (pBtn) {
                var pController = akra.ui.ide.getEngine().createAnimationController();
            ...
            Inspector.prototype._editCintroller = function (pControllerUI) {
                ...
                akra.ui.ide.cmd(4 /* INSPECT_ANIMATION_CONTROLLER */, pControllerUI.getController());
            };
            ...
            Inspector.prototype.inspectAnimationNode = function (pNode) {
                ...
                if (akra.ui.animation.Mask.isMaskNode(pNode)) {
        ...
        akra.ui.register("Inspector", Inspector);
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
})(akra || (akra = {}));
...
(function (akra) {
    ...
    (function (ui) {
            ...
            CodeEditor.prototype.finalizeRendere = function () {
                ...
                CodeMirror.commands.autocomplete = function (cm) {
                    CodeMirror.showHint(cm, CodeMirror.javascriptHint, {
                        additionalContext: { self: akra.ui.ide._apiEntry }
                    });
                };
        ...
        akra.ui.register("CodeEditor", CodeEditor);
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
})(akra || (akra = {}));
...
");
            ...
            akra.ui.register("ListenerEditor", ListenerEditor);
        })(ui.graph || (ui.graph = {}));
        var graph = ui.graph;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
        ...
        (function (graph) {
            ...
            var Graph = (function (_super) {
                ...
                Graph.prototype.createRouteFrom = function (pFrom) {
                    this._pTempRoute = new akra.ui.graph.TempRoute(pFrom);
                ...
                Graph.prototype.connectTo = function (pTo) {
                    ...
                    var pRoute = new akra.ui.graph.Route(pFrom, pTo);
                    pRoute.routing();
...
(function (akra) {
    (function (ui) {
        (function (graph) {
            ...
            akra.ui.register("GraphConnector", Connector);
        })(ui.graph || (ui.graph = {}));
        var graph = ui.graph;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
        ...
        (function (graph) {
            var ConnectionArea = (function (_super) {
                ...
                ConnectionArea.prototype.attachToParent = function (pParent) {
                    akra.logger.assert(akra.ui.isComponent(pParent, 20 /* GRAPH_NODE */), "only graph node can be parent!!");
                    if (_super.prototype.attachToParent.call(this, pParent)) {
                ...
                ConnectionArea.prototype.prepareForConnect = function () {
                    var pConnector = this._pTempConnect = new akra.ui.graph.Connector(this);
            ...
            function isConnectionArea(pEntity) {
                return akra.ui.isComponent(pEntity, 23 /* GRAPH_CONNECTIONAREA */);
            }
            graph.isConnectionArea = isConnectionArea;

            akra.ui.register("GraphConnectionArea", ConnectionArea);
        })(ui.graph || (ui.graph = {}));
        var graph = ui.graph;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
        ...
        (function (graph) {
            var MouseenterSignal = (function (_super) {
                ...
                MouseenterSignal.prototype.emit = function (e) {
                    ...
                    // this.routing();
                    pNode.sendEvent(akra.ui.graph.Graph.event(2 /* SHOW_MAP */));
                };
                return MouseenterSignal;
            })(akra.Signal);
            ...
            var MouseleaveSignal = (function (_super) {
                ...
                MouseleaveSignal.prototype.emit = function (e) {
                    ...
                    // this.routing();
                    pNode.sendEvent(akra.ui.graph.Graph.event(3 /* HIDE_MAP */));
                };
                return MouseleaveSignal;
            })(akra.Signal);
            ...
            var Node = (function (_super) {
                ...
                function Node(pGraph, options, eType, $el) {
                    if (typeof eType === "undefined") { eType = 0 /* UNKNOWN */; }
                    _super.call(this, akra.ui.getUI(pGraph), options, 20 /* GRAPH_NODE */, $el);
                    ...
                    akra.logger.assert(akra.ui.isComponent(pGraph, 19 /* GRAPH */), "only graph may be as parent", pGraph);
                ...
                Node.prototype.linkAreas = function () {
                    ...
                    for (var i = 0; i < pChildren.length; ++i) {
                        if (akra.ui.graph.isConnectionArea(pChildren[i])) {
                ...
                Node.prototype.init = function () {
                    ...
                    for (var i = 0; i < pSidesTB.length; ++i) {
                        ...
                        pSidePanels[i] = new akra.ui.graph.ConnectionArea(this, { show: false });
            ...
            akra.ui.register("graph.Node", Node);
        })(ui.graph || (ui.graph = {}));
        var graph = ui.graph;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
        ...
        (function (graph) {
            var Controls = (function (_super) {
                ...
                Controls.prototype.createNode = function () {
                    return new akra.ui.graph.Node(this.graph);
                };
            ...
            akra.ui.register("graph.Controls", Controls);
        })(ui.graph || (ui.graph = {}));
        var graph = ui.graph;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
    ...
    (function (ui) {
        ...
        (function (animation) {
            var Data = (function (_super) {
                ...
                return Data;
            })(akra.ui.animation.Node);
            animation.Data = Data;

            akra.ui.register("animation.Data", Data);
        })(ui.animation || (ui.animation = {}));
        var animation = ui.animation;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
...
(function (akra) {
    (function (ui) {
        ...
        (function (animation) {
            ...
            akra.ui.register("animation.Player", Player);
        })(ui.animation || (ui.animation = {}));
        var animation = ui.animation;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
...
(function (akra) {
    (function (ui) {
        ...
        (function (animation) {
            ...
            akra.ui.register("animation.Mask", Mask);
        })(ui.animation || (ui.animation = {}));
        var animation = ui.animation;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
...
(function (akra) {
    (function (ui) {
        ...
        (function (animation) {
            ...
            akra.ui.register("animation.Blender", Blender);
        })(ui.animation || (ui.animation = {}));
        var animation = ui.animation;
    })(akra.ui || (akra.ui = {}));
    var ui = akra.ui;
