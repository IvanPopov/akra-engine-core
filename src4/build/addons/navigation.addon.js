    ...
    (function (_addons) {
        ...
        */
        function navigation(pGeneralViewport, pParameters, pCallback) {
            ...
            akra.deps.load(pGeneralViewport.getTarget().getRenderer().getEngine(), akra.deps.createDependenceByPath("navigation/orientation_cube.ara", "ara"), pParameters.path || addons['navigation'].path, function (e, pDep) {
                if (!akra.isNull(e)) {
...
//# sourceMappingURL=navigation.addon.js.map
