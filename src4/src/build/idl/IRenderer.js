...
(function (akra) {
    ...
    (function (ERenderCapabilities) {
        ...
        ERenderCapabilities[ERenderCapabilities["GL1_5_NOVBO"] = CAPABILITYVALUE(2 /* C_WEBGL */, 1)] = "GL1_5_NOVBO";

        /// Support for Frame Buffer Objects (FBOs)
        ERenderCapabilities[ERenderCapabilities["FBO"] = CAPABILITYVALUE(2 /* C_WEBGL */, 2)] = "FBO";

        /// Support for Frame Buffer Objects ARB implementation (regular FBO is higher precedence)
        ERenderCapabilities[ERenderCapabilities["FBO_ARB"] = CAPABILITYVALUE(2 /* C_WEBGL */, 3)] = "FBO_ARB";

        /// Support for Frame Buffer Objects ATI implementation (ARB FBO is higher precedence)
        ERenderCapabilities[ERenderCapabilities["FBO_ATI"] = CAPABILITYVALUE(2 /* C_WEBGL */, 4)] = "FBO_ATI";

        /// Support for PBuffer
        ERenderCapabilities[ERenderCapabilities["PBUFFER"] = CAPABILITYVALUE(2 /* C_WEBGL */, 5)] = "PBUFFER";

        /// Support for GL 1.5 but without HW occlusion workaround
        ERenderCapabilities[ERenderCapabilities["GL1_5_NOHWOCCLUSION"] = CAPABILITYVALUE(2 /* C_WEBGL */, 6)] = "GL1_5_NOHWOCCLUSION";

        /// Support for point parameters ARB implementation
        ERenderCapabilities[ERenderCapabilities["POINT_EXTENDED_PARAMETERS_ARB"] = CAPABILITYVALUE(2 /* C_WEBGL */, 7)] = "POINT_EXTENDED_PARAMETERS_ARB";

        /// Support for point parameters EXT implementation
        ERenderCapabilities[ERenderCapabilities["POINT_EXTENDED_PARAMETERS_EXT"] = CAPABILITYVALUE(2 /* C_WEBGL */, 8)] = "POINT_EXTENDED_PARAMETERS_EXT";
