    ...
    (function (_addons) {
        ...
        */
        function navigation(pGeneralViewport, pParameters, pCallback) {
            ...
            akra.deps.load(pGeneralViewport.getTarget().getRenderer().getEngine(), akra.deps.createDependenceByPath(AE_NAVIGATION_DEPENDENCIES.path, AE_NAVIGATION_DEPENDENCIES.type), pParameters.path || addons['navigation'].path, function (e, pDep) {
                if (!akra.isNull(e)) {
