    ...
    (function (fx) {
        var ComplexTypeInstruction = (function (_super) {
            ...
            ComplexTypeInstruction.prototype.addField = function (pVariable) {
                ...
                if (this._iSize !== akra.fx.Instruction.UNDEFINE_SIZE) {
                    var iSize = pVariable.getType().getSize();
                    if (iSize !== akra.fx.Instruction.UNDEFINE_SIZE) {
                        this._iSize += iSize;
                    } else {
                        this._iSize = akra.fx.Instruction.UNDEFINE_SIZE;
                    }
                }
                ...
                if (akra.fx.Effect.isSamplerType(pType) || pType._containSampler()) {
            ...
            ComplexTypeInstruction.prototype._calcSize = function () {
                ...
                for (var i = 0; i < this._pFieldDeclList.length; i++) {
                    ...
                    if (iFieldSize === akra.fx.Instruction.UNDEFINE_SIZE) {
                        iSize = akra.fx.Instruction.UNDEFINE_SIZE;
                        break;
                    } else {
                        iSize += iFieldSize;
                    }
            ...
            ComplexTypeInstruction.prototype.calculatePaddings = function () {
                ...
                for (var i = 0; i < this._pFieldDeclList.length; i++) {
                    ...
                    if (iVarSize === akra.fx.Instruction.UNDEFINE_SIZE) {
                        this.setError(2272 /* CANNOT_CALCULATE_PADDINGS */, { typeName: this.getName() });
                        return;
                    }
...
//# sourceMappingURL=ComplexTypeInstruction.js.map
