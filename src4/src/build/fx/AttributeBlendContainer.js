    ...
    (function (fx) {
        ...
        var AttributeBlendContainer = (function (_super) {
            ...
            AttributeBlendContainer.prototype.getTypeForShaderAttributeBySemanticIndex = function (iIndex) {
                return this._pIsPointerBySlot[this.getSlotBySemanticIndex(iIndex)] ? akra.fx.Effect.getSystemType("ptr") : this.getTypeBySemanticIndex(iIndex).getBaseType();
            };
        ...
        })(akra.fx.VariableBlendContainer);
