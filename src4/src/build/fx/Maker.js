    ...
    (function (fx) {
        ...
        var Maker = (function () {
            ...
            Maker.prototype._make = function (pPassInput, pBufferMap) {
                ...
                if (akra.config.PROFILE_MAKER) {
                    ...
                    if (this._iCount % (100 * 300) === 0) {
                        akra.logger.log("----------------");
                        akra.logger.log("uniforms: ", this._pMakeTime[0]);
                        akra.logger.log("samplers: ", this._pMakeTime[1]);
                        akra.logger.log("sampler arrays: ", this._pMakeTime[2]);
                        akra.logger.log("attrs: ", this._pMakeTime[3]);
                        akra.logger.log("states: ", this._pMakeTime[4]);
                        akra.logger.log("----------------");
                        this._pMakeTime[0] = 0.;
                        this._pMakeTime[1] = 0.;
                        this._pMakeTime[2] = 0.;
            ...
            Maker.prototype.expandStructUniforms = function (pVariable, sPrevName) {
                ...
                if (isArray && (iLength === akra.fx.Instruction.UNDEFINE_LENGTH || iLength === 0)) {
                ...
                for (var i = 0; i < iLength; i++) {
                    ...
                    for (var j = 0; j < pFieldNameList.length; j++) {
                        ...
                        if (pField.getType().isComplex()) {
                            ...
                            var eFieldType = akra.fx.VariableContainer.getVariableType(pField);
