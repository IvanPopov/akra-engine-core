    ...
    (function (fx) {
        var VariableTypeInstruction = (function (_super) {
            ...
            function VariableTypeInstruction() {
                ...
                this._iLength = akra.fx.Instruction.UNDEFINE_LENGTH;
                ...
                this._iPadding = akra.fx.Instruction.UNDEFINE_PADDING;
            ...
            VariableTypeInstruction.prototype.isEqual = function (pType) {
                ...
                if (this.isNotBaseArray() && pType.isNotBaseArray() && (this.getLength() !== pType.getLength() || this.getLength() === akra.fx.Instruction.UNDEFINE_LENGTH || pType.getLength() === akra.fx.Instruction.UNDEFINE_LENGTH)) {
                    return false;
                }
            ...
            VariableTypeInstruction.prototype.isPointIndex = function () {
                if (akra.isNull(this._isPointIndex)) {
                    this._isPointIndex = this.isStrongEqual(akra.fx.Effect.getSystemType("ptr"));
                }
            ...
            VariableTypeInstruction.prototype.isFromVariableDecl = function () {
                if (!akra.isNull(this._isFromVariableDecl)) {
            ...
            VariableTypeInstruction.prototype.isFromTypeDecl = function () {
                if (!akra.isNull(this._isFromTypeDecl)) {
            ...
            VariableTypeInstruction.prototype.isUniform = function () {
                if (akra.isNull(this._isUniform)) {
            ...
            VariableTypeInstruction.prototype.isForeign = function () {
                if (akra.isNull(this._isForeign)) {
            ...
            VariableTypeInstruction.prototype.addArrayIndex = function (pExpr) {
                ...
                this._iLength = this._pArrayIndexExpr.evaluate() ? this._pArrayIndexExpr.getEvalValue() : akra.fx.Instruction.UNDEFINE_LENGTH;

                this._isArray = true;

                if (this._iLength === akra.fx.Instruction.UNDEFINE_LENGTH) {
            ...
            VariableTypeInstruction.prototype.initializePointers = function () {
                ...
                for (var i = 0; i < this.getPointDim(); i++) {
                    var pPointer = new akra.fx.VariableDeclInstruction();
                    var pPointerType = new VariableTypeInstruction();
                    var pPointerId = new akra.fx.IdInstruction();

                    pPointer.push(pPointerType, true);
                    pPointer.push(pPointerId, true);

                    pPointerType.pushType(akra.fx.Effect.getSystemType("ptr"));
                    pPointerId.setName(akra.fx.Instruction.UNDEFINE_NAME);
            ...
            VariableTypeInstruction.prototype._setVideoBufferInDepth = function () {
                if (this.isPointer()) {
                    this.setVideoBuffer(akra.fx.Effect.createVideoBufferVariable());
            ...
            VariableTypeInstruction.prototype.getSize = function () {
                ...
                if (this._isArray) {
                    ...
                    if (this._iLength === akra.fx.Instruction.UNDEFINE_LENGTH || iSize === akra.fx.Instruction.UNDEFINE_SIZE) {
                        return akra.fx.Instruction.UNDEFINE_SIZE;
                    } else {
            ...
            VariableTypeInstruction.prototype.getLength = function () {
                ...
                } else if (this._iLength === akra.fx.Instruction.UNDEFINE_LENGTH || this._isNeedToUpdateLength) {
                    var isEval = this._pArrayIndexExpr.evaluate();

                    if (isEval) {
                        var iValue = this._pArrayIndexExpr.getEvalValue();
                        this._iLength = akra.isInt(iValue) ? iValue : akra.fx.Instruction.UNDEFINE_LENGTH;
                    }
                }
            ...
            VariableTypeInstruction.prototype.getField = function (sFieldName) {
                ...
                if (!this._isUnverifiable()) {
                    ...
                    var pFieldName = new akra.fx.IdInstruction();
            ...
            VariableTypeInstruction.prototype.hasUsage = function (sUsageName) {
                ...
                if (!akra.isNull(this.getSubType()) && this.getSubType()._getInstructionType() === 3 /* k_VariableTypeInstruction */) {
            ...
            VariableTypeInstruction.prototype.getFieldExpr = function (sFieldName) {
                ...
                var pExpr = new akra.fx.IdExprInstruction();
            ...
            VariableTypeInstruction.prototype._getMainPointer = function () {
                if (akra.isNull(this._pMainPointIndex)) {
                    if (akra.isNull(this.getPointer())) {
            ...
            VariableTypeInstruction.prototype.blend = function (pType, eMode) {
                ...
                if (this.isNotBaseArray() || this.getLength() === akra.fx.Instruction.UNDEFINE_LENGTH || this.getLength() !== pType.getLength()) {
                    return null;
                }
                ...
                if (this.isNotBaseArray()) {
                    ...
                    var pLengthExpr = new akra.fx.IntInstruction();
            ...
            VariableTypeInstruction.prototype.canHaveSubDecls = function () {
                return this.isComplex() || this.isPointer() || !akra.isNull(this._pAttrOffset);
            };
