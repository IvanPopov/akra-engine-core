        ...
        var Mat4 = (function () {
            function Mat4(f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16) {
                ...
                if (n === 2) {
                    ...
                    switch (n) {
                        case 1:
                            if (arguments[0] instanceof akra.math.Mat3) {
                                this.set(arguments[0], akra.math.Vec3.temp(0.));
                            } else {
                                this.set(arguments[0]);
                            }
                            break;
            ...
            Mat4.prototype.set = function (f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16) {
                ...
                if (nArgumentsLength === 1) {
                    if (akra.isFloat(arguments[0])) {
                        ...
                        pData[__43] = 0.;
                        pData[__44] = fValue;
                    } else if (arguments[0] instanceof akra.math.Vec4) {
            ...
            Mat4.prototype.isEqual = function (m4fMat, fEps) {
                ...
                if (fEps === 0.) {
                    ...
                    if (akra.math.abs(pData1[__11] - pData2[__11]) > fEps || akra.math.abs(pData1[__12] - pData2[__12]) > fEps || akra.math.abs(pData1[__13] - pData2[__13]) > fEps || akra.math.abs(pData1[__14] - pData2[__14]) > fEps || akra.math.abs(pData1[__21] - pData2[__21]) > fEps || akra.math.abs(pData1[__22] - pData2[__22]) > fEps || akra.math.abs(pData1[__23] - pData2[__23]) > fEps || akra.math.abs(pData1[__24] - pData2[__24]) > fEps || akra.math.abs(pData1[__31] - pData2[__31]) > fEps || akra.math.abs(pData1[__32] - pData2[__32]) > fEps || akra.math.abs(pData1[__33] - pData2[__33]) > fEps || akra.math.abs(pData1[__34] - pData2[__34]) > fEps || akra.math.abs(pData1[__41] - pData2[__41]) > fEps || akra.math.abs(pData1[__42] - pData2[__42]) > fEps || akra.math.abs(pData1[__43] - pData2[__43]) > fEps || akra.math.abs(pData1[__44] - pData2[__44]) > fEps) {
                        return false;
                    }
                }
                return true;
            ...
            Mat4.prototype.isDiagonal = function (fEps) {
                ...
                if (fEps === 0.) {
                    ...
                    if (akra.math.abs(pData[__12]) > fEps || akra.math.abs(pData[__13]) > fEps || akra.math.abs(pData[__14]) > fEps || akra.math.abs(pData[__21]) > fEps || akra.math.abs(pData[__23]) > fEps || akra.math.abs(pData[__24]) > fEps || akra.math.abs(pData[__31]) > fEps || akra.math.abs(pData[__32]) > fEps || akra.math.abs(pData[__34]) > fEps || akra.math.abs(pData[__41]) > fEps || akra.math.abs(pData[__42]) > fEps || akra.math.abs(pData[__43]) > fEps) {
                        return false;
                    }
                }
                return true;
            ...
            Mat4.prototype.toQuat4 = function (q4fDestination) {
                ...
                var fMax = akra.math.max(x2, akra.math.max(y2, akra.math.max(z2, w2)));

                if (fMax == x2) {
                    //максимальная компонента берется положительной
                    var x = akra.math.sqrt(x2);
            ...
            Mat4.prototype.rotateRight = function (fAngle, v3fAxis, m4fDestination) {
                ...
                var fSin = akra.math.sin(fAngle);
                var fCos = akra.math.cos(fAngle);
                var fTmp = 1. - fCos;
            ...
            /**  */ Mat4.prototype.getTranslation = function (v3fTranslation) {
                if (!akra.isDef(v3fTranslation)) {
                    v3fTranslation = new akra.math.Vec3();
                }
            ...
            /**  */ Mat4.perspective = function (fFovy, fAspect, fNear, fFar, m4fDestination) {
                var fTop = fNear * akra.math.tan(fFovy / 2.);
            ...
            Mat4.lookAt = function (v3fEye, v3fCenter, v3fUp, m4fDestination) {
                ...
                fLength = akra.math.sqrt(fZNewX * fZNewX + fZNewY * fZNewY + fZNewZ * fZNewZ);
                ...
                fLength = akra.math.sqrt(fXNewX * fXNewX + fXNewY * fXNewY + fXNewZ * fXNewZ);
                if (fLength) {
                    fInvLength = 1. / fLength;
