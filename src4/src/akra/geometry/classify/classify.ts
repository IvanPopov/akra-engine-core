...
module akra.geometry.classify {
	...
	export function rect2d(pRectA: IRect2d, pRectB: IRect2d): EVolumeClassifications {
	...
	export function rect3d(pRectA: IRect3d, pRectB: IRect3d): EVolumeClassifications {
		var fRectAX0: float = pRectA.x0, fRectAX1: float = pRectA.x1;
		var fRectAY0: float = pRectA.y0, fRectAY1: float = pRectA.y1;
