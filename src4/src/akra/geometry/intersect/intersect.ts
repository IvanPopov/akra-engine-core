...
module akra.geometry.intersect {
    ...
    export function intersectRect2dRay2d(pRect: IRect2d, pRay: IRay2d): boolean {
        var v2fNormal: IVec2 = pRay.normal;
    ...
    export function intersectRect3dRay3d(pRect: IRect3d, pRay: IRay3d): boolean {
        var v3fNormal: IVec3 = pRay.normal;
    ...
    export function intersectRect2dRect2d(pRect1: IRect2d, pRect2: IRect2d, pResult?: IRect2d): boolean {
        if (!isDef(pResult)) {
    ...
    export function intersectRect3dRect3d(pRect1: IRect3d, pRect2: IRect3d, pResult?: IRect3d): boolean {
        if (!isDef(pResult)) {
            var fX0: float = math.max(pRect1.x0, pRect2.x0);
            var fX1: float = math.min(pRect1.x1, pRect2.x1);
            if (fX0 <= fX1) {
