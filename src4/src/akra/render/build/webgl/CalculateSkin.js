...
(function (akra) {
    ...
    (function (webgl) {
        function calculateSkin(pMeshSubset) {
            ...
            var pOldFrameBuffer = pWebGLRenderer.getParameter(gl.FRAMEBUFFER_BINDING);
            ...
            //PASS 1
            ///////////////////////////////////////////////
            pWebGLContext.drawArrays(gl.POINT, pIndexData.byteOffset / iStride, pIndexData.length);
