...
(function (akra) {
    ...
    (function (pool) {
        var ResourcePoolItem = (function (_super) {
            ...
            function ResourcePoolItem(/*pManager: IResourcePoolManager*/ ) {
                _super.call(this);
                this.guid = akra.guid();
                this.created = new akra.Signal(this);
                this.destroyed = new akra.Signal(this);
                this.loaded = new akra.Signal(this);
                this.unloaded = new akra.Signal(this);
                this.restored = new akra.Signal(this);
                this.disabled = new akra.Signal(this);
                this.altered = new akra.Signal(this);
                this.saved = new akra.Signal(this);
                ...
                this._pStateWatcher = [];
                this._pCallbackSlots = akra.gen.array(akra.EResourceItemEvents.TOTALRESOURCEFLAGS);
            }
            ...
            Object.defineProperty(ResourcePoolItem.prototype, "alteredFlag", {
                get: function () {
                    return akra.bf.testBit(this._iResourceFlags, akra.EResourceItemEvents.ALTERED);
                },
                enumerable: true,
                configurable: true
            });
            ...
            ResourcePoolItem.prototype.getManager = function () {
                return (this._pResourcePool).manager;
            };
            ...
            ResourcePoolItem.prototype.isResourceCreated = function () {
                return akra.bf.testBit(this._iResourceFlags, akra.EResourceItemEvents.CREATED);
            };

            ResourcePoolItem.prototype.isResourceLoaded = function () {
                return akra.bf.testBit(this._iResourceFlags, akra.EResourceItemEvents.LOADED);
            };

            ResourcePoolItem.prototype.isResourceDisabled = function () {
                return akra.bf.testBit(this._iResourceFlags, akra.EResourceItemEvents.DISABLED);
            };
