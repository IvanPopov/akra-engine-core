...
module akra.scene.light {
	...
	export class ProjectLight extends LightPoint implements IProjectLight {
        ...
        protected _iSplitNumber: uint;
        protected _fSplitParatemer: float;
        protected _pSplitCamera: ICamera[] = null;
		...
		create(isShadowCaster: boolean = true, iMaxShadowResolution: uint = 256, iSplitNumber: uint = 4, fSplitParameter: float = 0.5): boolean {
            ...
            this._iSplitNumber = iSplitNumber;
