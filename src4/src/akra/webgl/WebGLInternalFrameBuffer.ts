...
module akra.webgl {
	...
	export class WebGLInternalFrameBuffer {
		...
		destroy(): void {
		 ...
		 get width(): uint {
			return this._pAttachments[gl.COLOR_ATTACHMENT0].width;
		}

		 get height(): uint {
			return this._pAttachments[gl.COLOR_ATTACHMENT0].height;
		}

		 get format(): uint {
			return this._pAttachments[gl.COLOR_ATTACHMENT0].format;
		}
