...
module akra.ui {
	...
	export class Component extends DNDNode implements IUIComponent {
		...
		protected _pComponentOptions: IUIComponentOptions = null;
		 ...
		 get componentType(): EUIComponents { return this._eComponentType; }
		 get genericType(): string { return this._sGenericType; }
		 ...
		 get options(): IUIComponentOptions {
		...
		_createdFrom($comp: JQuery): void {
			...
			this.el.attr("id", "cuid-" + this.guid);
		}
