...
var akra;
(function (akra) {
    akra.logger = akra.util.Logger.getInstance();
    ...
    (function (parser) {
        ...
        var Lexer = (function () {
            ...
            Lexer.prototype.getNextToken = function () {
                ...
                var pToken;
                switch (eType) {
                    case parser.ETokenType.k_NumericLiteral:
                        pToken = this.scanNumber();
                        break;
                    case parser.ETokenType.k_CommentLiteral:
                        this.scanComment();
                        pToken = this.getNextToken();
                        break;
                    case parser.ETokenType.k_StringLiteral:
                        pToken = this.scanString();
                        break;
                    case parser.ETokenType.k_PunctuatorLiteral:
                        pToken = this.scanPunctuator();
                        break;
                    case parser.ETokenType.k_IdentifierLiteral:
                        pToken = this.scanIdentifier();
                        break;
                    case parser.ETokenType.k_WhitespaceLiteral:
                        this.scanWhiteSpace();
                        pToken = this.getNextToken();
                        break;
                    default:
            ...
            Lexer.prototype.identityTokenType = function () {
                if (this.isIdentifierStart()) {
                    return parser.ETokenType.k_IdentifierLiteral;
                }
                if (this.isWhiteSpaceStart()) {
                    return parser.ETokenType.k_WhitespaceLiteral;
                }
                if (this.isStringStart()) {
                    return parser.ETokenType.k_StringLiteral;
                }
                if (this.isCommentStart()) {
                    return parser.ETokenType.k_CommentLiteral;
                }
                if (this.isNumberStart()) {
                    return parser.ETokenType.k_NumericLiteral;
                }
                if (this.isPunctuatorStart()) {
                    return parser.ETokenType.k_PunctuatorLiteral;
                }
                return parser.ETokenType.k_Unknown;
            };
            ...
            Lexer.prototype.scanString = function () {
                ...
                if (isGoodFinish) {
                    ...
                    this._error(LEXER_BAD_TOKEN, {
                        type: parser.ETokenType.k_StringLiteral,
                        value: sValue,
                        start: iStart,
                        end: this._iColumnNumber,
                        line: this._iLineNumber
            ...
            Lexer.prototype.scanNumber = function () {
                ...
                if (isGoodFinish) {
                    ...
                    sValue += ch;
                    this._error(LEXER_BAD_TOKEN, {
                        type: parser.ETokenType.k_NumericLiteral,
                        value: sValue,
                        start: iStart,
                        end: this._iColumnNumber,
                        line: this._iLineNumber
            ...
            Lexer.prototype.scanIdentifier = function () {
                ...
                if (isGoodFinish) {
                    ...
                    sValue += ch;
                    this._error(LEXER_BAD_TOKEN, {
                        type: parser.ETokenType.k_IdentifierLiteral,
                        value: sValue,
                        start: iStart,
                        end: this._iColumnNumber,
                        line: this._iLineNumber
            ...
            Lexer.prototype.scanComment = function () {
                ...
                if (ch === "/") {
                    ...
                    if (isGoodFinish) {
                        ...
                        sValue += ch;
                        this._error(LEXER_BAD_TOKEN, {
                            type: parser.ETokenType.k_CommentLiteral,
                            value: sValue,
                            start: iStart,
                            end: this._iColumnNumber,
                            line: this._iLineNumber
    ...
    (function (parser) {
        var ParseTree = (function () {
            ...
            ParseTree.prototype.reduceByRule = function (pRule, eCreate) {
                if (typeof eCreate === "undefined") { eCreate = parser.ENodeCreateMode.k_Default; }
                var iReduceCount = 0;
                ...
                if ((eCreate === parser.ENodeCreateMode.k_Default && iReduceCount > nOptimize) || (eCreate === parser.ENodeCreateMode.k_Necessary)) {
                    pNode = {
                        name: pRule.left,
                        children: null,
                        parent: null,
    ...
    (function (parser) {
        var Item = (function () {
            ...
            Item.prototype.isEqual = function (pItem, eType) {
                if (typeof eType === "undefined") { eType = parser.EParserType.k_LR0; }
