...
declare module akra {
    ...
    interface IRenderableObject extends akra.IEventProvider {
        ...
        shadowed: akra.ISignal<(pRenderable: IRenderableObject, bValue: boolean) => void>;
        beforeRender: akra.ISignal<(pRenderable: IRenderableObject, pViewport: any, pMethod: any) => void>;
...
declare module akra {
    ...
    interface IDepHandler {
        (pEngine: akra.IEngine, pDep: IDep, cb: (pDep: IDep, eStatus: EDependenceStatuses, pData?: any) => void): void;
    }
}
declare module akra {
    enum EGamepadCodes {
...
declare module akra {
    interface IEngineOptions {
        ...
        */
        progress: (e: akra.IDepEvent) => void;
    }
...
declare module akra {
    interface IResourceNotifyRoutineFunc {
        (pSender: akra.IResourcePoolItem, iFlagBit?: number, iResourceFlags?: number, isSet?: boolean): void;
        (pSender: akra.IResourcePoolItem, eEvent?: akra.EResourceItemEvents, iResourceFlags?: number, isSet?: boolean): void;
    }
}
/**
...
declare module akra {
    ...
    interface IResourcePoolItem extends akra.IReferenceCounter, akra.IEventProvider {
        ...
        stateChanged: akra.ISignal<(pResource: IResourcePoolItem, eEvent: EResourceItemEvents, iFlags: number, isSet: boolean) => any>;
        /** resource code */
...
declare module akra {
    ...
    interface IFile extends akra.IEventProvider {
        opened: akra.ISignal<(pFile: IFile) => void>;
        closed: akra.ISignal<(pFile: IFile) => void>;
        renamed: akra.ISignal<(pFile: IFile, sName: string, sNamePrev: string) => void>;
        getPath(): string;
        getName(): string;
        getByteLength(): number;
        getMode(): number;
...
declare module akra.io {
    class TFile implements akra.IFile {
        public guid: number;
        public opened: akra.ISignal<(pFile: akra.IFile) => void>;
        public closed: akra.ISignal<(pFile: akra.IFile) => void>;
        public renamed: akra.ISignal<(pFile: akra.IFile, sName: string, sNamePrev: string) => void>;
        ...
        constructor(sFilename?: string, sMode?: string, cb?: (e: Error, pMeta: akra.IFileMeta) => void);
        constructor(sFilename?: string, iMode?: number, cb?: (e: Error, pMeta: akra.IFileMeta) => void);
        public setupSignals(): void;
        ...
        public open(sFilename: string, iMode: number, cb?: (e: Error, pMeta: akra.IFileMeta) => void): void;
        public open(sFilename: string, sMode: string, cb?: (e: Error, pMeta: akra.IFileMeta) => void): void;
        public open(sFilename: string, cb?: (e: Error, pMeta: akra.IFileMeta) => void): void;
        public open(iMode: number, cb?: (e: Error, pMeta: akra.IFileMeta) => void): void;
        public open(cb?: (e: Error, pMeta: akra.IFileMeta) => void): void;
        public close(): void;
        ...
        public copy(sFilename: string, cb?: (e: Error, pCopy: akra.IFile, pMeta: akra.IFileMeta) => void): void;
        ...
        public getMetaData(cb: (e: Error, pMeta: akra.IFileMeta) => void): void;
...
declare module akra.pool {
    interface ICallbackSlot {
        ...
        resource: akra.IResourcePoolItem;
        event: akra.EResourceItemEvents;
    }
    class ResourcePoolItem extends akra.util.ReferenceCounter implements akra.IResourcePoolItem {
        ...
        public stateChanged: akra.ISignal<(pResource: akra.IResourcePoolItem, eEvent: akra.EResourceItemEvents, iFlags: number, isSet: boolean) => any>;
        ...
        */
        public findRelatedResources(eState: akra.EResourceItemEvents): akra.IResourcePoolItem[];
        public isSyncComplete(eSignal: akra.EResourceItemEvents): boolean;
        ...
        */
        public sync(pResourceItem: akra.IResourcePoolItem, eSignal: string, eSlot?: string): boolean;
...
declare module akra.fx.instructions {
    class TypedInstruction extends instructions.Instruction implements akra.IAFXTypedInstruction {
...
declare module akra.fx.instructions {
    class ExprInstruction extends instructions.TypedInstruction implements akra.IAFXExprInstruction {
...
declare module akra.fx.instructions {
    ...
    */
    class ArithmeticExprInstruction extends instructions.ExprInstruction {
        constructor();
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
        public evaluate(): boolean;
        public toFinalCode(): string;
...
declare module akra.fx.instructions {
    ...
    * (=|+=|-=|*=|/=|%=) Instruction Instruction
    */
    class AssignmentExprInstruction extends instructions.ExprInstruction {
        constructor();
        public toFinalCode(): string;
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
    }
...
declare module akra.fx.instructions {
    class BoolInstruction extends instructions.ExprInstruction implements akra.IAFXLiteralInstruction {
        private _bValue;
...
declare module akra.fx.instructions {
    ...
    */
    class StmtInstruction extends instructions.Instruction implements akra.IAFXStmtInstruction {
        constructor();
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
    }
}
declare module akra.fx.instructions {
    ...
    */
    class BreakStmtInstruction extends instructions.StmtInstruction {
        constructor();
        public toFinalCode(): string;
    }
}
declare module akra.fx.instructions {
    ...
    */
    class CastExprInstruction extends instructions.ExprInstruction {
        constructor();
        public toFinalCode(): string;
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
        public isConst(): boolean;
...
declare module akra.fx.instructions {
    ...
    */
    class ComplexExprInstruction extends instructions.ExprInstruction {
        constructor();
        public toFinalCode(): string;
        public isConst(): boolean;
        public evaluate(): boolean;
...
declare module akra.fx.instructions {
    class ComplexTypeInstruction extends instructions.Instruction implements akra.IAFXTypeInstruction {
        private _sName;
        private _sRealName;
        private _sHash;
...
declare module akra.fx.instructions {
    ...
    */
    class CompileExprInstruction extends instructions.ExprInstruction {
        constructor();
...
declare module akra.fx.instructions {
    ...
    */
    class ConditionalExprInstruction extends instructions.ExprInstruction {
        constructor();
        public toFinalCode(): string;
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
        public isConst(): boolean;
...
declare module akra.fx.instructions {
    ...
    */
    class ConstructorCallInstruction extends instructions.ExprInstruction {
        constructor();
        public toFinalCode(): string;
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
        public isConst(): boolean;
...
declare module akra.fx.instructions {
    ...
    */
    class DeclStmtInstruction extends instructions.StmtInstruction {
        constructor();
        public toFinalCode(): string;
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
    }
...
declare module akra.fx.instructions {
    ...
    */
    class ExprStmtInstruction extends instructions.StmtInstruction {
        constructor();
        public toFinalCode(): string;
    }
}
declare module akra.fx.instructions {
    class SimpleInstruction extends instructions.Instruction implements akra.IAFXSimpleInstruction {
        private _sValue;
...
declare module akra.fx.instructions {
    class ExtractExprInstruction extends instructions.ExprInstruction {
...
declare module akra.fx.instructions {
    class ExtractStmtInstruction extends instructions.ExprInstruction {
...
declare module akra.fx.instructions {
    class FloatInstruction extends instructions.ExprInstruction implements akra.IAFXLiteralInstruction {
        private _fValue;
        /**
        * EMPTY_OPERATOR EMPTY_ARGUMENTS
        */
...
declare module akra.fx.instructions {
    ...
    */
    class ForStmtInstruction extends instructions.StmtInstruction {
        constructor();
        public toFinalCode(): string;
        public check(eStage: akra.ECheckStage, pInfo?: any): boolean;
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
...
declare module akra.fx.instructions {
    ...
    */
    class FunctionCallInstruction extends instructions.ExprInstruction {
        constructor();
        public toFinalCode(): string;
        public getFunction(): akra.IAFXFunctionDeclInstruction;
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
...
declare module akra.fx.instructions {
    class DeclInstruction extends instructions.TypedInstruction implements akra.IAFXDeclInstruction {
...
declare module akra.fx.instructions {
    ...
    */
    class FunctionDefInstruction extends instructions.DeclInstruction {
...
declare module akra.fx.instructions {
    class IdInstruction extends instructions.Instruction implements akra.IAFXIdInstruction {
        private _sName;
        private _sRealName;
...
declare module akra.fx.instructions {
    class IdExprInstruction extends instructions.ExprInstruction implements akra.IAFXIdExprInstruction {
...
declare module akra.fx.instructions {
    ...
    */
    class IfStmtInstruction extends instructions.StmtInstruction {
        constructor();
        public toFinalCode(): string;
    }
}
declare module akra.fx.instructions {
    class IntInstruction extends instructions.ExprInstruction implements akra.IAFXLiteralInstruction {
        private _iValue;
        /**
        * EMPTY_OPERATOR EMPTY_ARGUMENTS
        */
...
declare module akra.fx.instructions {
    class InstructionCollector extends instructions.Instruction {
        constructor();
        public toFinalCode(): string;
    }
}
declare module akra.fx.instructions {
    ...
    */
    class SamplerStateBlockInstruction extends instructions.ExprInstruction {
        private _pTexture;
...
declare module akra.fx.instructions {
    ...
    */
    class StmtBlockInstruction extends instructions.StmtInstruction {
        constructor();
        public toFinalCode(): string;
    }
}
declare module akra.fx.instructions {
    class VariableTypeInstruction extends instructions.Instruction implements akra.IAFXVariableTypeInstruction {
        private _pSubType;
        private _pUsageList;
        private _sName;
        private _isWritable;
...
declare module akra.fx.instructions {
    ...
    */
    class FunctionDeclInstruction extends instructions.DeclInstruction implements akra.IAFXFunctionDeclInstruction {
        public _pFunctionDefenition: instructions.FunctionDefInstruction;
        public _pImplementation: instructions.StmtBlockInstruction;
...
declare module akra.fx.instructions {
    class InitExprInstruction extends instructions.ExprInstruction implements akra.IAFXInitExprInstruction {
...
declare module akra.fx.instructions {
    ...
    * (&& | ||) Instruction Instruction
    */
    class LogicalExprInstruction extends instructions.ExprInstruction {
        constructor();
        public toFinalCode(): string;
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
        public isConst(): boolean;
...
declare module akra.fx.instructions {
    class MemExprInstruction extends instructions.ExprInstruction {
        private _pBuffer;
        constructor();
...
declare module akra.fx.instructions {
    class PassInstruction extends instructions.DeclInstruction implements akra.IAFXPassInstruction {
...
declare module akra.fx.instructions {
    ...
    * (-- | ++) Instruction
    */
    class PostfixArithmeticInstruction extends instructions.ExprInstruction {
        constructor();
        public toFinalCode(): string;
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
        public isConst(): boolean;
...
declare module akra.fx.instructions {
    ...
    */
    class PostfixIndexInstruction extends instructions.ExprInstruction {
...
declare module akra.fx.instructions {
    class PostfixPointInstruction extends instructions.ExprInstruction {
...
declare module akra.fx.instructions {
    ...
    * @ Instruction
    */
    class PrimaryExprInstruction extends instructions.ExprInstruction {
        constructor();
        public toFinalCode(): string;
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
    }
...
declare module akra.fx.instructions {
    ...
    * (==|!=|<|>|<=|>=) Instruction Instruction
    */
    class RelationalExprInstruction extends instructions.ExprInstruction {
        constructor();
        public toFinalCode(): string;
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
        public isConst(): boolean;
...
declare module akra.fx.instructions {
    ...
    */
    class ReturnStmtInstruction extends instructions.StmtInstruction {
...
declare module akra.fx.instructions {
    ...
    * ;
    */
    class SemicolonStmtInstruction extends instructions.StmtInstruction {
        constructor();
        public toFinalCode(): string;
    }
}
declare module akra.fx.instructions {
    class StringInstruction extends instructions.ExprInstruction implements akra.IAFXLiteralInstruction {
        private _sValue;
...
declare module akra.fx.instructions {
    class SystemFunctionInstruction extends instructions.DeclInstruction implements akra.IAFXFunctionDeclInstruction {
...
declare module akra.fx.instructions {
    ...
    */
    class SystemCallInstruction extends instructions.ExprInstruction {
...
declare module akra.fx.instructions {
    class SystemTypeInstruction extends instructions.Instruction implements akra.IAFXTypeInstruction {
        private _sName;
        private _sRealName;
...
declare module akra.fx.instructions {
    class TechniqueInstruction extends instructions.DeclInstruction implements akra.IAFXTechniqueInstruction {
        private _sName;
...
declare module akra.fx.instructions {
    class TypeDeclInstruction extends instructions.DeclInstruction implements akra.IAFXTypeDeclInstruction {
        constructor();
        public getType(): akra.IAFXTypeInstruction;
...
declare module akra.fx.instructions {
    ...
    * (+|-|!|++|--|) Instruction
    */
    class UnaryExprInstruction extends instructions.ExprInstruction {
        constructor();
        public toFinalCode(): string;
        public addUsedData(pUsedDataCollector: akra.IAFXTypeUseInfoMap, eUsedMode?: akra.EVarUsedMode): void;
        public isConst(): boolean;
...
declare module akra.fx.instructions {
    ...
    */
    class WhileStmtInstruction extends instructions.StmtInstruction {
        constructor();
        public toFinalCode(): string;
    }
}
declare module akra.fx {
    class Effect implements akra.IAFXEffect {
        ...
        static pSystemTypes: akra.IMap<fx.instructions.SystemTypeInstruction>;
        static pSystemFunctions: akra.IMap<fx.instructions.SystemFunctionInstruction[]>;
        static pSystemVariables: akra.IAFXVariableDeclMap;
        static pSystemVertexOut: fx.instructions.ComplexTypeInstruction;
        ...
        static getBaseVertexOutType(): fx.instructions.ComplexTypeInstruction;
        static getSystemType(sTypeName: string): fx.instructions.SystemTypeInstruction;
...
declare module akra.fx.instructions {
    class VariableDeclInstruction extends instructions.DeclInstruction implements akra.IAFXVariableDeclInstruction {
...
declare module akra.render {
    class RenderableObject implements akra.IRenderableObject {
        public guid: number;
        public shadowed: akra.ISignal<(pRenderable: akra.IRenderableObject, bValue: boolean) => void>;
        public beforeRender: akra.ISignal<(pRenderable: akra.IRenderableObject, pViewport: any, pMethod: any) => void>;
...
declare module akra.pool.resources {
    ...
    class Obj extends pool.ResourcePoolItem implements akra.IObj {
        ...
        public getBasename(): string;
        private setFilename(sName);
        public setOptions(pOptions: akra.IObjLoadOptions): void;
        public attachToScene(pScene: akra.IScene3d): akra.IModelEntry;
        public attachToScene(pNode: akra.ISceneNode): akra.IModelEntry;
...
declare module akra.deps {
    ...
    */
    function addDependenceHandler(pTypes: string[], fnPoolSelector: (pRsmgr: akra.IResourcePoolManager) => akra.IResourcePool<any>, fnHandler: akra.IDepHandler): void;
    /** Get lowest level of deps. */
    function getLowestLevel(pDeps: akra.IDependens): akra.IDependens;
    ...
    */
    ...
    function countFiles(pDeps: akra.IDependens): number;
    /**
    * Make the <path> absolute for IDep
    */
    function normalize(pDeps: akra.IDependens, sRoot?: string, iDepth?: number): void;
    function getType(pDep: akra.IDep): string;
    function loadResource(pEngine: akra.IEngine, pDep: akra.IDep, cb: (pDep: akra.IDep, eStatus: akra.EDependenceStatuses, pData?: any) => void): void;
    function loadMap(pEngine: akra.IEngine, pDep: akra.IDep, cb: (pDep: akra.IDep, eStatus: akra.EDependenceStatuses, pData?: any) => void): void;
    function loadGrammar(pEngine: akra.IEngine, pDep: akra.IDep, cb: (pDep: akra.IDep, eStatus: akra.EDependenceStatuses, pData?: any) => void): void;
    function loadCustom(pEngine: akra.IEngine, pDep: akra.IDep, cb: (pDep: akra.IDep, eStatus: akra.EDependenceStatuses, pData?: any) => void): void;
    function loadJSON(pEngine: akra.IEngine, pDep: akra.IDep, cb: (pDep: akra.IDep, eStatus: akra.EDependenceStatuses, pData?: any) => void): void;
    function loadBSON(pEngine: akra.IEngine, pDep: akra.IDep, cb: (pDep: akra.IDep, eStatus: akra.EDependenceStatuses, pData?: any) => void): void;
    function loadARA(pEngine: akra.IEngine, pArchiveDep: akra.IDep, cb: (pDep: akra.IDep, eStatus: akra.EDependenceStatuses, pData?: any) => void): void;
    /**
    ...
    */
    function load(pEngine: akra.IEngine, pDeps: akra.IDependens, sRoot: string, fnLoaded: (e: Error, pDeps: akra.IDependens) => void, fnProgress?: (e: akra.IDepEvent) => void): void;
    function link(pParent: akra.IDependens, pChild: akra.IDependens): akra.IDependens;
    function createDependenceByPath(sPath: string, sType?: string, sRoot?: string): akra.IDependens;
}
...
declare module akra.core {
    class Engine implements akra.IEngine {
        ...
        public ready(cb?: (pEngine: akra.IEngine) => void): boolean;
    }
}
declare module akra {
