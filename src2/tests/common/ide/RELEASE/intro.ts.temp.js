...
(function (akra) {
    ...
    function createViewports() {
        ...
        if (akra.isNull(pUI)) {
            pCanvas.resize(akra.pParentElement.offsetWidth, akra.pParentElement.offsetHeight);
    ...
    function createHero() {
        loadModels("@HERO_MODEL", function (pNode) {
            ...
            var pMovie = pRmgr.loadModel("@HERO_INTRO");
