#ifndef UTIL_CALCULATE_PLANES_FOR_LIGHTING
#define UTIL_CALCULATE_PLANES_FOR_LIGHTING
...
module akra.util{
	export function calculatePlanesForFrustumLighting(pLightFrustum: IFrustum, v3fLightPosition: IVec3,
		...
		var v3fNormal: IVec3 = vec3();
		var fDistance: float;

		var pPlanePoints: IVec3[] = [vec3(), vec3(), vec3(), vec3()];

		var v3fTmp: IVec3 = vec3();
	...
	export function calculatePlanesForOrthogonalLighting(pLightFrustum: IFrustum, v3fLightPosition: IVec3,
		...
		var v3fLightDirection: IVec3 = pLightFrustum.getViewDirection(vec3());
		var fThreshold: float = 0.1;
