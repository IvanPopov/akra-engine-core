...
declare module TypeScript {
    enum SyntaxKind {
        ...
        LessThanToken = 95,
        GreaterThanToken = 96,
        LessThanEqualsToken = 97,
        GreaterThanEqualsToken = 98,
        EqualsEqualsToken = 99,
        EqualsGreaterThanToken = 100,
        ExclamationEqualsToken = 101,
        EqualsEqualsEqualsToken = 102,
        ExclamationEqualsEqualsToken = 103,
        PlusToken = 104,
        MinusToken = 105,
        AsteriskToken = 106,
        PercentToken = 107,
        PlusPlusToken = 108,
        MinusMinusToken = 109,
        LessThanLessThanToken = 110,
        GreaterThanGreaterThanToken = 111,
        GreaterThanGreaterThanGreaterThanToken = 112,
        AmpersandToken = 113,
        BarToken = 114,
        CaretToken = 115,
        ExclamationToken = 116,
        TildeToken = 117,
        AmpersandAmpersandToken = 118,
        BarBarToken = 119,
        QuestionToken = 120,
        ColonToken = 121,
        EqualsToken = 122,
        PlusEqualsToken = 123,
        MinusEqualsToken = 124,
        AsteriskEqualsToken = 125,
        PercentEqualsToken = 126,
        LessThanLessThanEqualsToken = 127,
        GreaterThanGreaterThanEqualsToken = 128,
        GreaterThanGreaterThanGreaterThanEqualsToken = 129,
        AmpersandEqualsToken = 130,
        BarEqualsToken = 131,
        CaretEqualsToken = 132,
        SlashToken = 133,
        SlashEqualsToken = 134,
        SourceUnit = 135,
        QualifiedName = 136,
        ObjectType = 137,
        FunctionType = 138,
        ...
        GenericType = 141,
        TypeQuery = 142,
        InterfaceDeclaration = 143,
        FunctionDeclaration = 144,
        ModuleDeclaration = 145,
        ClassDeclaration = 146,
        EnumDeclaration = 147,
        ImportDeclaration = 148,
        ExportAssignment = 149,
        MemberFunctionDeclaration = 150,
        MemberVariableDeclaration = 151,
        ConstructorDeclaration = 152,
        IndexMemberDeclaration = 153,
        GetAccessor = 154,
        SetAccessor = 155,
        ...
        DoStatement = 176,
        DebuggerStatement = 177,
        WithStatement = 178,
        PlusExpression = 179,
        NegateExpression = 180,
        BitwiseNotExpression = 181,
        LogicalNotExpression = 182,
        PreIncrementExpression = 183,
        PreDecrementExpression = 184,
        DeleteExpression = 185,
        TypeOfExpression = 186,
        VoidExpression = 187,
        CommaExpression = 188,
        AssignmentExpression = 189,
        AddAssignmentExpression = 190,
        SubtractAssignmentExpression = 191,
        MultiplyAssignmentExpression = 192,
        DivideAssignmentExpression = 193,
        ModuloAssignmentExpression = 194,
        AndAssignmentExpression = 195,
        ExclusiveOrAssignmentExpression = 196,
        OrAssignmentExpression = 197,
        LeftShiftAssignmentExpression = 198,
        SignedRightShiftAssignmentExpression = 199,
        UnsignedRightShiftAssignmentExpression = 200,
        ConditionalExpression = 201,
        LogicalOrExpression = 202,
        LogicalAndExpression = 203,
        BitwiseOrExpression = 204,
        BitwiseExclusiveOrExpression = 205,
        BitwiseAndExpression = 206,
        EqualsWithTypeConversionExpression = 207,
        NotEqualsWithTypeConversionExpression = 208,
        EqualsExpression = 209,
        NotEqualsExpression = 210,
        LessThanExpression = 211,
        GreaterThanExpression = 212,
        LessThanOrEqualExpression = 213,
        GreaterThanOrEqualExpression = 214,
        InstanceOfExpression = 215,
        InExpression = 216,
        LeftShiftExpression = 217,
        SignedRightShiftExpression = 218,
        UnsignedRightShiftExpression = 219,
        MultiplyExpression = 220,
        DivideExpression = 221,
        ModuloExpression = 222,
        AddExpression = 223,
        SubtractExpression = 224,
        PostIncrementExpression = 225,
        PostDecrementExpression = 226,
        MemberAccessExpression = 227,
        InvocationExpression = 228,
        ArrayLiteralExpression = 229,
        ObjectLiteralExpression = 230,
        ObjectCreationExpression = 231,
        ParenthesizedExpression = 232,
        ParenthesizedArrowFunctionExpression = 233,
        SimpleArrowFunctionExpression = 234,
        CastExpression = 235,
        ElementAccessExpression = 236,
        FunctionExpression = 237,
        OmittedExpression = 238,
        VariableDeclaration = 239,
        VariableDeclarator = 240,
        ArgumentList = 241,
        ParameterList = 242,
        TypeArgumentList = 243,
        TypeParameterList = 244,
        ExtendsHeritageClause = 245,
        ImplementsHeritageClause = 246,
        EqualsValueClause = 247,
        CaseSwitchClause = 248,
        DefaultSwitchClause = 249,
        ElseClause = 250,
        CatchClause = 251,
        FinallyClause = 252,
        TypeParameter = 253,
        Constraint = 254,
        SimplePropertyAssignment = 255,
        FunctionPropertyAssignment = 256,
        Parameter = 257,
        EnumElement = 258,
        TypeAnnotation = 259,
        ExternalModuleReference = 260,
        ModuleNameModuleReference = 261,
        Last = 261,
